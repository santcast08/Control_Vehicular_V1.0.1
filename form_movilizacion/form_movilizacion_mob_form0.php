...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_movilizacion_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_movilizacion_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['recarga'];
}
?>
<body class="scFormPage" style="<?php echo $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_movilizacion']['error_buffer']) && '' != $_SESSION['scriptcase']['form_movilizacion']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_movilizacion']['error_buffer'];
}
...
<?php
 include_once("form_movilizacion_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_movilizacion_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_movilizacion_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_movilizacion_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['fast_search'][2] : "";
?> 
...
<?php echo nmButtonOutput($this->arr_buttons, "bnovo", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Enter)", "sc-unique-btn-20", "", "group_2_t");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bincluir", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_ins_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Enter)", "sc-unique-btn-21", "", "group_2_t");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bcancelar", "scBtnFn_sys_format_cnl()", "scBtnFn_sys_format_cnl()", "sc_b_sai_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Escape)", "sc-unique-btn-22", "", "group_2_t");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "balterar", "scBtnFn_sys_format_alt()", "scBtnFn_sys_format_alt()", "sc_b_upd_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + S)", "sc-unique-btn-23", "", "group_2_t");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bexcluir", "scBtnFn_sys_format_exc()", "scBtnFn_sys_format_exc()", "sc_b_del_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Delete)", "sc-unique-btn-24", "", "group_2_t");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bcopy", "scBtnFn_sys_format_copy()", "scBtnFn_sys_format_copy()", "sc_b_clone_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Shift + C)", "sc-unique-btn-26", "", "group_2_t");?>
  </div>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "scBtnFn_sys_format_sai()", "scBtnFn_sys_format_sai()", "sc_b_sai_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + Q)", "sc-unique-btn-29", "", "");?>
 
<?php
        $NM_btn = true;
    }
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "scBtnFn_sys_format_sai()", "scBtnFn_sys_format_sai()", "sc_b_sai_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + Q)", "sc-unique-btn-31", "", "");?>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_id_movilizacion_line" id="hidden_field_data_id_movilizacion" style="<?php echo $sStyleHidden_id_movilizacion; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_movilizacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_movilizacion_label"><span id="id_label_id_movilizacion"><?php echo $this->nm_new_label['id_movilizacion']; ?></span></span><br><span id="id_read_on_id_movilizacion" class="css_id_movilizacion_line" style="<?php echo $sStyleReadLab_id_movilizacion; ?>"><?php echo $this->form_encode_input($this->id_movilizacion); ?></span><span id="id_read_off_id_movilizacion" style="<?php echo $sStyleReadInp_id_movilizacion; ?>"><input type="hidden" name="id_movilizacion" value="<?php echo $this->form_encode_input($id_movilizacion) . "\">"?><span id="id_ajax_label_id_movilizacion"><?php echo nl2br($id_movilizacion); ?></span>
</span></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_id_movilizacion_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_id_movilizacion_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }
      else
      {
         $sc_hidden_no--;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_fecha_line" id="hidden_field_data_movilizacion_fecha" style="<?php echo $sStyleHidden_movilizacion_fecha; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_fecha_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_fecha_label"><span id="id_label_movilizacion_fecha"><?php echo $this->nm_new_label['movilizacion_fecha']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idusuario_line" id="hidden_field_data_idusuario" style="<?php echo $sStyleHidden_idusuario; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idusuario_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idusuario_label"><span id="id_label_idusuario"><?php echo $this->nm_new_label['idusuario']; ?></span></span><br>
...
<input type=hidden name="idvehiculo" value="<?php echo $this->form_encode_input($this->idvehiculo) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_idvehiculo_line" id="hidden_field_data_idvehiculo" style="<?php echo $sStyleHidden_idvehiculo; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idvehiculo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idvehiculo_label"><span id="id_label_idvehiculo"><?php echo $this->nm_new_label['idvehiculo']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["idvehiculo"]) &&  $this->nmgp_cmp_readonly["idvehiculo"] == "on") { 
...
{ 
   ...
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->idvehiculo_1))
          {
              foreach ($this->idvehiculo_1 as $tmp_idvehiculo)
              {
                  if (trim($tmp_idvehiculo) === trim($cadaselect[1])) { $idvehiculo_look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->idvehiculo) === trim($cadaselect[1])) { $idvehiculo_look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type="hidden" name="idvehiculo" value="<?php echo $this->form_encode_input($idvehiculo) . "\">" . $idvehiculo_look . ""; ?>
<?php } else { ?>
<?php
   $todo = $this->Form_lookup_idvehiculo();
   $x = 0 ; 
   $idvehiculo_look = ""; 
   while (!empty($todo[$x])) 
   {
          ...
          if (empty($idvehiculo_look))
          {
              $idvehiculo_look = $this->idvehiculo;
          }
   $x = 0; 
   echo "<span id=\"id_read_on_idvehiculo\" class=\"css_idvehiculo_line\" style=\"" .  $sStyleReadLab_idvehiculo . "\">" . $this->form_encode_input($idvehiculo_look) . "</span><span id=\"id_read_off_idvehiculo\" style=\"" . $sStyleReadInp_idvehiculo . "\">";
   echo " <span id=\"idAjaxSelect_idvehiculo\"><select class=\"sc-js-input scFormObjectOdd css_idvehiculo_obj\" style=\"\" id=\"id_sc_field_idvehiculo\" name=\"idvehiculo\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          if (trim($this->idvehiculo) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
...
?> 
<?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_idvehiculo_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_idvehiculo_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
   if (!isset($this->nm_new_label['km_galon']))
   {
       $this->nm_new_label['km_galon'] = "Kilometraje Promedio por Galón";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $km_galon = $this->km_galon;
   $sStyleHidden_km_galon = '';
   if (isset($this->nmgp_cmp_hidden['km_galon']) && $this->nmgp_cmp_hidden['km_galon'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['km_galon']);
       $sStyleHidden_km_galon = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_km_galon = 'display: none;';
   $sStyleReadInp_km_galon = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['km_galon']) && $this->nmgp_cmp_readonly['km_galon'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['km_galon']);
       $sStyleReadLab_km_galon = '';
       $sStyleReadInp_km_galon = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['km_galon']) && $this->nmgp_cmp_hidden['km_galon'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="km_galon" value="<?php echo $this->form_encode_input($this->km_galon) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_km_galon_line" id="hidden_field_data_km_galon" style="<?php echo $sStyleHidden_km_galon; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_km_galon_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_km_galon_label"><span id="id_label_km_galon"><?php echo $this->nm_new_label['km_galon']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["km_galon"]) &&  $this->nmgp_cmp_readonly["km_galon"] == "on") { 
...
{ 
   ...
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->km_galon_1))
          {
              foreach ($this->km_galon_1 as $tmp_km_galon)
              {
                  if (trim($tmp_km_galon) === trim($cadaselect[1])) { $km_galon_look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->km_galon) === trim($cadaselect[1])) { $km_galon_look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type="hidden" name="km_galon" value="<?php echo $this->form_encode_input($km_galon) . "\">" . $km_galon_look . ""; ?>
<?php } else { ?>
<?php
   $todo = $this->Form_lookup_km_galon();
   $x = 0 ; 
   $km_galon_look = ""; 
   while (!empty($todo[$x])) 
   {
          ...
          if (empty($km_galon_look))
          {
              $km_galon_look = $this->km_galon;
          }
   $x = 0; 
   echo "<span id=\"id_read_on_km_galon\" class=\"css_km_galon_line\" style=\"" .  $sStyleReadLab_km_galon . "\">" . $this->form_encode_input($km_galon_look) . "</span><span id=\"id_read_off_km_galon\" style=\"" . $sStyleReadInp_km_galon . "\">";
   echo " <span id=\"idAjaxSelect_km_galon\"><select class=\"sc-js-input scFormObjectOdd css_km_galon_obj\" style=\"\" id=\"id_sc_field_km_galon\" name=\"km_galon\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          if (trim($this->km_galon) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
          {
              if (empty($this->km_galon)) 
              {
                  echo " selected" ;
              } 
           } 
...
?> 
<?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_km_galon_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_km_galon_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $sStyleHidden_km_galon_dumb = ('' == $sStyleHidden_km_galon) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_km_galon_dumb" style="<?php echo $sStyleHidden_km_galon_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
   ...
   echo " <span id=\"idAjaxSelect_movilizacion_funcionario\"><select class=\"sc-js-input scFormObjectOdd css_movilizacion_funcionario_obj\" style=\"\" id=\"id_sc_field_movilizacion_funcionario\" name=\"movilizacion_funcionario\" size=\"10\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   ...
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          ...
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          if (trim($this->movilizacion_funcionario) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
...
<TABLE align="center" id="hidden_bloco_2" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['movilizacion_hora_salida'] = "Hora de Salida";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_hora_salida_line" id="hidden_field_data_movilizacion_hora_salida" style="<?php echo $sStyleHidden_movilizacion_hora_salida; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_hora_salida_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_hora_salida_label"><span id="id_label_movilizacion_hora_salida"><?php echo $this->nm_new_label['movilizacion_hora_salida']; ?></span></span><br>
...
<span id="id_read_on_movilizacion_hora_salida" class="sc-ui-readonly-movilizacion_hora_salida css_movilizacion_hora_salida_line" style="<?php echo $sStyleReadLab_movilizacion_hora_salida; ?>"><?php echo $this->form_encode_input($movilizacion_hora_salida); ?></span><span id="id_read_off_movilizacion_hora_salida" style="white-space: nowrap;<?php echo $sStyleReadInp_movilizacion_hora_salida; ?>">
 ...
 size=8 alt="{datatype: 'time', timeSep: '<?php echo $this->field_config['movilizacion_hora_salida']['time_sep']; ?>', timeFormat: '<?php echo $this->field_config['movilizacion_hora_salida']['date_format']; ?>', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ><?php
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['movilizacion_km_salida'] = "Kilometraje de Salida";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_km_salida_line" id="hidden_field_data_movilizacion_km_salida" style="<?php echo $sStyleHidden_movilizacion_km_salida; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_km_salida_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_km_salida_label"><span id="id_label_movilizacion_km_salida"><?php echo $this->nm_new_label['movilizacion_km_salida']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["movilizacion_km_salida"]) &&  $this->nmgp_cmp_readonly["movilizacion_km_salida"] == "on") { 

 ?>
<input type="hidden" name="movilizacion_km_salida" value="<?php echo $this->form_encode_input($movilizacion_km_salida) . "\">" . $movilizacion_km_salida . ""; ?>
<?php } else { ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['movilizacion_hora_llegada'] = "Hora de Llegada";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_hora_llegada_line" id="hidden_field_data_movilizacion_hora_llegada" style="<?php echo $sStyleHidden_movilizacion_hora_llegada; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_hora_llegada_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_hora_llegada_label"><span id="id_label_movilizacion_hora_llegada"><?php echo $this->nm_new_label['movilizacion_hora_llegada']; ?></span></span><br>
...
<span id="id_read_on_movilizacion_hora_llegada" class="sc-ui-readonly-movilizacion_hora_llegada css_movilizacion_hora_llegada_line" style="<?php echo $sStyleReadLab_movilizacion_hora_llegada; ?>"><?php echo $this->form_encode_input($movilizacion_hora_llegada); ?></span><span id="id_read_off_movilizacion_hora_llegada" style="white-space: nowrap;<?php echo $sStyleReadInp_movilizacion_hora_llegada; ?>">
 ...
 size=8 alt="{datatype: 'time', timeSep: '<?php echo $this->field_config['movilizacion_hora_llegada']['time_sep']; ?>', timeFormat: '<?php echo $this->field_config['movilizacion_hora_llegada']['date_format']; ?>', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ><?php
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['movilizacion_km_llegada'] = "Kilometraje de Llegada";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_km_llegada_line" id="hidden_field_data_movilizacion_km_llegada" style="<?php echo $sStyleHidden_movilizacion_km_llegada; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_km_llegada_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_km_llegada_label"><span id="id_label_movilizacion_km_llegada"><?php echo $this->nm_new_label['movilizacion_km_llegada']; ?></span></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['movilizacion_costo_galon'] = "Costo por Galón";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_costo_galon_line" id="hidden_field_data_movilizacion_costo_galon" style="<?php echo $sStyleHidden_movilizacion_costo_galon; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_costo_galon_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_costo_galon_label"><span id="id_label_movilizacion_costo_galon"><?php echo $this->nm_new_label['movilizacion_costo_galon']; ?></span></span><br>
...
<span id="id_read_on_movilizacion_costo_galon" class="sc-ui-readonly-movilizacion_costo_galon css_movilizacion_costo_galon_line" style="<?php echo $sStyleReadLab_movilizacion_costo_galon; ?>"><?php echo $this->form_encode_input($this->movilizacion_costo_galon); ?></span><span id="id_read_off_movilizacion_costo_galon" style="white-space: nowrap;<?php echo $sStyleReadInp_movilizacion_costo_galon; ?>">
 ...
 size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['movilizacion_costo_galon']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['movilizacion_costo_galon']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['movilizacion_costo_galon']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_cant_km_adicional_line" id="hidden_field_data_movilizacion_cant_km_adicional" style="<?php echo $sStyleHidden_movilizacion_cant_km_adicional; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_cant_km_adicional_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_cant_km_adicional_label"><span id="id_label_movilizacion_cant_km_adicional"><?php echo $this->nm_new_label['movilizacion_cant_km_adicional']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_recorrido_vehiculo_line" id="hidden_field_data_movilizacion_recorrido_vehiculo" style="<?php echo $sStyleHidden_movilizacion_recorrido_vehiculo; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_recorrido_vehiculo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_recorrido_vehiculo_label"><span id="id_label_movilizacion_recorrido_vehiculo"><?php echo $this->nm_new_label['movilizacion_recorrido_vehiculo']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["movilizacion_recorrido_vehiculo"]) &&  $this->nmgp_cmp_readonly["movilizacion_recorrido_vehiculo"] == "on") { 

 ?>
<input type="hidden" name="movilizacion_recorrido_vehiculo" value="<?php echo $this->form_encode_input($movilizacion_recorrido_vehiculo) . "\">" . $movilizacion_recorrido_vehiculo . ""; ?>
<?php } else { ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['movilizacion_total_km_recorrido'] = "Total Kilometraje Recorrido";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_total_km_recorrido_line" id="hidden_field_data_movilizacion_total_km_recorrido" style="<?php echo $sStyleHidden_movilizacion_total_km_recorrido; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_total_km_recorrido_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_total_km_recorrido_label"><span id="id_label_movilizacion_total_km_recorrido"><?php echo $this->nm_new_label['movilizacion_total_km_recorrido']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["movilizacion_total_km_recorrido"]) &&  $this->nmgp_cmp_readonly["movilizacion_total_km_recorrido"] == "on") { 

 ?>
<input type="hidden" name="movilizacion_total_km_recorrido" value="<?php echo $this->form_encode_input($movilizacion_total_km_recorrido) . "\">" . $movilizacion_total_km_recorrido . ""; ?>
<?php } else { ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_excedente_line" id="hidden_field_data_movilizacion_excedente" style="<?php echo $sStyleHidden_movilizacion_excedente; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_excedente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_excedente_label"><span id="id_label_movilizacion_excedente"><?php echo $this->nm_new_label['movilizacion_excedente']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["movilizacion_excedente"]) &&  $this->nmgp_cmp_readonly["movilizacion_excedente"] == "on") { 

 ?>
<input type="hidden" name="movilizacion_excedente" value="<?php echo $this->form_encode_input($movilizacion_excedente) . "\">" . $movilizacion_excedente . ""; ?>
<?php } else { ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['movilizacion_total_galones'] = "Total Galones Usados";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_total_galones_line" id="hidden_field_data_movilizacion_total_galones" style="<?php echo $sStyleHidden_movilizacion_total_galones; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_total_galones_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_total_galones_label"><span id="id_label_movilizacion_total_galones"><?php echo $this->nm_new_label['movilizacion_total_galones']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["movilizacion_total_galones"]) &&  $this->nmgp_cmp_readonly["movilizacion_total_galones"] == "on") { 

 ?>
<input type="hidden" name="movilizacion_total_galones" value="<?php echo $this->form_encode_input($movilizacion_total_galones) . "\">" . $movilizacion_total_galones . ""; ?>
<?php } else { ?>
<span id="id_read_on_movilizacion_total_galones" class="sc-ui-readonly-movilizacion_total_galones css_movilizacion_total_galones_line" style="<?php echo $sStyleReadLab_movilizacion_total_galones; ?>"><?php echo $this->form_encode_input($this->movilizacion_total_galones); ?></span><span id="id_read_off_movilizacion_total_galones" style="white-space: nowrap;<?php echo $sStyleReadInp_movilizacion_total_galones; ?>">
 ...
 size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['movilizacion_total_galones']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['movilizacion_total_galones']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['movilizacion_total_galones']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php $sStyleHidden_movilizacion_total_galones_dumb = ('' == $sStyleHidden_movilizacion_total_galones) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_movilizacion_total_galones_dumb" style="<?php echo $sStyleHidden_movilizacion_total_galones_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_movilizacion_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_movilizacion_mob_empty.htm' : $this->Ini->link_form_detalle_movilizacion_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion']) && 'nmsc_iframe_liga_form_detalle_movilizacion_mob' != $this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detalle_movilizacion'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_detalle_movilizacion_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="500" width="100%" name="nmsc_iframe_liga_form_detalle_movilizacion_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "binicio", "scBtnFn_sys_format_ini()", "scBtnFn_sys_format_ini()", "sc_b_ini_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Shift + &#8592;)", "sc-unique-btn-32", "", "");?>
...
<?php
    ...
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['first'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "binicio_off", "scBtnFn_sys_format_ini()", "scBtnFn_sys_format_ini()", "sc_b_ini_off_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Shift + &#8592;)", "sc-unique-btn-33", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bretorna", "scBtnFn_sys_format_ret()", "scBtnFn_sys_format_ret()", "sc_b_ret_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + &#8592;)", "sc-unique-btn-34", "", "");?>
...
<?php
    ...
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['back'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bretorna_off", "scBtnFn_sys_format_ret()", "scBtnFn_sys_format_ret()", "sc_b_ret_off_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + &#8592;)", "sc-unique-btn-35", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bavanca", "scBtnFn_sys_format_ava()", "scBtnFn_sys_format_ava()", "sc_b_avc_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + &#8594;)", "sc-unique-btn-36", "", "");?>
...
<?php
    ...
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['forward'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bavanca_off", "scBtnFn_sys_format_ava()", "scBtnFn_sys_format_ava()", "sc_b_avc_off_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + &#8594;)", "sc-unique-btn-37", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bfinal", "scBtnFn_sys_format_fim()", "scBtnFn_sys_format_fim()", "sc_b_fim_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Shift + &#8594;)", "sc-unique-btn-38", "", "");?>
...
<?php
    ...
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['last'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bfinal_off", "scBtnFn_sys_format_fim()", "scBtnFn_sys_format_fim()", "sc_b_fim_off_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Shift + &#8594;)", "sc-unique-btn-39", "", "");?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_movilizacion_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_movilizacion_mob");
 parent.scAjaxDetailHeight("form_movilizacion_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	...
	function scBtnFn_sys_format_ini() {
		...
		if ($("#sc_b_ini_off_b.sc-unique-btn-33").length && $("#sc_b_ini_off_b.sc-unique-btn-33").is(":visible")) {
			nm_move ('inicio');
			 return;
		}
	}
	function scBtnFn_sys_format_ret() {
		...
		if ($("#sc_b_ret_off_b.sc-unique-btn-35").length && $("#sc_b_ret_off_b.sc-unique-btn-35").is(":visible")) {
			nm_move ('retorna');
			 return;
		}
	}
	function scBtnFn_sys_format_ava() {
		...
		if ($("#sc_b_avc_off_b.sc-unique-btn-37").length && $("#sc_b_avc_off_b.sc-unique-btn-37").is(":visible")) {
			nm_move ('avanca');
			 return;
		}
	}
	function scBtnFn_sys_format_fim() {
		...
		if ($("#sc_b_fim_b.sc-unique-btn-38").length && $("#sc_b_fim_b.sc-unique-btn-38").is(":visible")) {
			nm_move ('final');
			 return;
		}
		if ($("#sc_b_fim_off_b.sc-unique-btn-39").length && $("#sc_b_fim_off_b.sc-unique-btn-39").is(":visible")) {
			nm_move ('final');
			 return;
		}
	}
