<?php
//
class form_movilizacion_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['km_galon']))
          {
              $this->km_galon = $this->NM_ajax_info['param']['km_galon'];
          }
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_movilizacion_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_movilizacion_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_movilizacion_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_movilizacion_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_movilizacion_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_movilizacion_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_movilizacion_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_movilizacion_mob']['label'] = "Ingreso Hoja de Rutas y Control de Combustible y Kilometraje";
      ...
      $_SESSION['scriptcase']['error_icon']['form_movilizacion_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_movilizacion_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_movilizacion_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_movilizacion_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dados_form'];
          if (!isset($this->movilizacion_ruta)){$this->movilizacion_ruta = $this->nmgp_dados_form['movilizacion_ruta'];} 
          if (!isset($this->libre)){$this->libre = $this->nmgp_dados_form['libre'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_movilizacion_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_movilizacion/form_movilizacion_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_movilizacion_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_movilizacion_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_movilizacion_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_movilizacion/form_movilizacion_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_movilizacion_mob_erro.class.php"); 
      }
      $this->Erro      = new form_movilizacion_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['opcao']))
         { 
             if ($this->id_movilizacion != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_detalle_movilizacion_mob') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_detalle_movilizacion_mob') . "/form_detalle_movilizacion_mob_apl.php");
          $this->form_detalle_movilizacion_mob = new form_detalle_movilizacion_mob_apl;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['movilizacion_km_salida']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['movilizacion_km_salida']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      ...
      $this->field_config['movilizacion_costo_galon']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['movilizacion_costo_galon']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['movilizacion_costo_galon']['symbol_dec'] = '';
      $this->field_config['movilizacion_costo_galon']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['movilizacion_costo_galon']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      ...
      $this->field_config['movilizacion_total_galones']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['movilizacion_total_galones']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['movilizacion_total_galones']['symbol_dec'] = '';
      $this->field_config['movilizacion_total_galones']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['movilizacion_total_galones']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_km_galon' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'km_galon');
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['recarga'] = $this->nmgp_opcao;
      }
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_movilizacion_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_movilizacion_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_movilizacion_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_movilizacion_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ('' == $filtro || 'km_galon' == $filtro)
        $this->ValidateField_km_galon($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
//---
    ...
    {
        global $teste_validade;
               if (!empty($this->idusuario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idusuario']) && !in_array($this->idusuario, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idusuario']))
               {
    ...
    {
        global $teste_validade;
               if (!empty($this->idvehiculo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idvehiculo']) && !in_array($this->idvehiculo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idvehiculo']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_km_galon(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
               if (!empty($this->km_galon) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_km_galon']) && !in_array($this->km_galon, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_km_galon']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['km_galon']))
                   {
                       $Campos_Erros['km_galon'] = array();
                   }
                   $Campos_Erros['km_galon'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['km_galon']) || !is_array($this->NM_ajax_info['errList']['km_galon']))
                   {
                       $this->NM_ajax_info['errList']['km_galon'] = array();
                   }
                   $this->NM_ajax_info['errList']['km_galon'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
    } // ValidateField_km_galon

    function ValidateField_movilizacion_funcionario(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->movilizacion_funcionario == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['php_cmp_required']['movilizacion_funcionario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['php_cmp_required']['movilizacion_funcionario'] == "on"))
      {
          ...
          if (!empty($this->movilizacion_funcionario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_movilizacion_funcionario']) && !in_array($this->movilizacion_funcionario, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_movilizacion_funcionario']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['movilizacion_funcionario']))
              {
    ...
    function ValidateField_movilizacion_km_salida(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->movilizacion_km_salida, 12, 0, -0, 999999999999, "N") == false)  
              { 
    ...
    function ValidateField_movilizacion_km_llegada(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->movilizacion_km_llegada, 12, 0, -0, 999999999999, "N") == false)  
              { 
    ...
    function ValidateField_movilizacion_costo_galon(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      nm_limpa_numero($this->movilizacion_costo_galon, $this->field_config['movilizacion_costo_galon']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->movilizacion_costo_galon != '')  
          { 
              ...
              { 
                  $Campos_Crit .= "Costo por Galón: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->movilizacion_costo_galon, 12, 0, -0, 999999999999, "N") == false)  
              { 
                  $Campos_Crit .= "Costo por Galón; " ; 
                  if (!isset($Campos_Erros['movilizacion_costo_galon']))
                  {
                      $Campos_Erros['movilizacion_costo_galon'] = array();
                  }
    ...
    function ValidateField_movilizacion_cant_km_adicional(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->movilizacion_cant_km_adicional, 11, 0, -0, 99999999999, "N") == false)  
              { 
    ...
    function ValidateField_movilizacion_recorrido_vehiculo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->movilizacion_recorrido_vehiculo, 12, 0, -0, 999999999999, "N") == false)  
              { 
    ...
    function ValidateField_movilizacion_total_km_recorrido(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->movilizacion_total_km_recorrido, 12, 0, -0, 999999999999, "N") == false)  
              { 
    ...
    function ValidateField_movilizacion_excedente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->movilizacion_excedente, 12, 0, -0, 999999999999, "N") == false)  
              { 
    ...
    function ValidateField_movilizacion_total_galones(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      nm_limpa_numero($this->movilizacion_total_galones, $this->field_config['movilizacion_total_galones']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->movilizacion_total_galones != '')  
          { 
              ...
              if ($teste_validade->Valor($this->movilizacion_total_galones, 12, 0, -0, 999999999999, "N") == false)  
              { 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      {
          nmgp_Form_Num_Val($this->movilizacion_costo_galon, $this->field_config['movilizacion_costo_galon']['symbol_grp'], $this->field_config['movilizacion_costo_galon']['symbol_dec'], "0", "S", $this->field_config['movilizacion_costo_galon']['format_neg'], "", "", "-", $this->field_config['movilizacion_costo_galon']['symbol_fmt']) ; 
      }
      ...
      {
          nmgp_Form_Num_Val($this->movilizacion_total_galones, $this->field_config['movilizacion_total_galones']['symbol_grp'], $this->field_config['movilizacion_total_galones']['symbol_dec'], "0", "S", $this->field_config['movilizacion_total_galones']['format_neg'], "", "", "-", $this->field_config['movilizacion_total_galones']['symbol_fmt']) ; 
      }
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_km_galon();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_movilizacion']['keyVal'] = form_movilizacion_mob_pack_protect_string($this->nmgp_dados_form['id_movilizacion']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['foreign_key']['id_movilizacion'] = $this->nmgp_dados_form['id_movilizacion'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['where_filter'] = "Id_Movilizacion = " . $this->nmgp_dados_form['id_movilizacion'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['where_detal']  = "Id_Movilizacion = " . $this->nmgp_dados_form['id_movilizacion'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['total']);
              }
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idusuario']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idusuario'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idusuario']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idusuario'] = array(); 
}
$aLookup[] = array(form_movilizacion_mob_pack_protect_string('') => form_movilizacion_mob_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idusuario'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_movilizacion_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_movilizacion_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idusuario'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idusuario']['valList'][$i] = form_movilizacion_mob_pack_protect_string($v);
          }
   ...
   function ajax_return_values_idvehiculo($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("idvehiculo", $this->nmgp_refresh_fields)) || $bForce)
          {
              ...
              $aLookup = array();
              $this->_tmp_lookup_idvehiculo = $this->idvehiculo;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idvehiculo']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idvehiculo'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idvehiculo']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idvehiculo'] = array(); 
}
if ($this->idusuario != "")
{ 
   $this->nm_clear_val("idusuario");
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   $nm_comando = "SELECT IdVehiculo, Concat('Modelo: ',vehiculos.Vehiculo_Modelo,'---Placa: ',vehiculos.Vehiculo_Placa)   FROM usuario, vehiculos WHERE vehiculos.usuario_idusuario = '$this->idusuario' AND usuario.idusuario = vehiculos.usuario_idusuario";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idvehiculo'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"idvehiculo\"";
          if (isset($this->NM_ajax_info['select_html']['idvehiculo']) && !empty($this->NM_ajax_info['select_html']['idvehiculo']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['idvehiculo'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->idvehiculo == $sValue)
                  {
                      $this->_tmp_lookup_idvehiculo = $sLabel;
                  }
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['idvehiculo']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['idvehiculo']['valList'][$i] = form_movilizacion_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['idvehiculo']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['idvehiculo']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['idvehiculo']['labList'] = $aLabel;
          }
   }

          //----- km_galon
   function ajax_return_values_km_galon($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("km_galon", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->km_galon);
              $aLookup = array();
              $this->_tmp_lookup_km_galon = $this->km_galon;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_km_galon']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_km_galon'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_km_galon']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_km_galon'] = array(); 
}
if ($this->idusuario != "")
{ 
   $this->nm_clear_val("idusuario");
   ...
   $nm_comando = "SELECT Vehiculo_Km_Galon , Vehiculo_Km_Galon  FROM usuario, vehiculos WHERE vehiculos.usuario_idusuario = '$this->idusuario' AND usuario.idusuario = vehiculos.usuario_idusuario";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_km_galon'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"km_galon\"";
          if (isset($this->NM_ajax_info['select_html']['km_galon']) && !empty($this->NM_ajax_info['select_html']['km_galon']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['km_galon'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->km_galon == $sValue)
                  {
                      $this->_tmp_lookup_km_galon = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['km_galon'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['km_galon']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['km_galon']['valList'][$i] = form_movilizacion_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['km_galon']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['km_galon']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['km_galon']['labList'] = $aLabel;
          }
   }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_movilizacion_funcionario']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_movilizacion_funcionario'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_movilizacion_funcionario']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_movilizacion_funcionario'] = array(); 
}
$aLookup[] = array(form_movilizacion_mob_pack_protect_string('') => form_movilizacion_mob_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_movilizacion_funcionario'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_movilizacion_funcionario'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"movilizacion_funcionario\"";
          if (isset($this->NM_ajax_info['select_html']['movilizacion_funcionario']) && !empty($this->NM_ajax_info['select_html']['movilizacion_funcionario']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['movilizacion_funcionario'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->movilizacion_funcionario == $sValue)
                  {
                      $this->_tmp_lookup_movilizacion_funcionario = $sLabel;
                  }
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['movilizacion_funcionario']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['movilizacion_funcionario']['valList'][$i] = form_movilizacion_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_detalle_movilizacion($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['form_movilizacion_mob']['contr_erro'] = 'on';
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_movilizacion_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_movilizacion_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET movilizacion_funcionario = '$this->movilizacion_funcionario', Movilizacion_Fecha = " . $this->Ini->date_delim . $this->movilizacion_fecha . $this->Ini->date_delim1 . ", Movilizacion_Hora_Salida = " . $this->Ini->date_delim . $this->movilizacion_hora_salida . $this->Ini->date_delim1 . ", Movilizacion_Hora_Llegada = " . $this->Ini->date_delim . $this->movilizacion_hora_llegada . $this->Ini->date_delim1 . ", Movilizacion_Km_Salida = $this->movilizacion_km_salida, Movilizacion_Km_Llegada = $this->movilizacion_km_llegada, Movilizacion_Costo_Galon = $this->movilizacion_costo_galon, movilizacion_cant_km_adicional = $this->movilizacion_cant_km_adicional, Movilizacion_Total_Km_Recorrido = $this->movilizacion_total_km_recorrido, movilizacion_Recorrido_Vehiculo = $this->movilizacion_recorrido_vehiculo, movilizacion_Excedente = $this->movilizacion_excedente, Movilizacion_Total_Galones = $this->movilizacion_total_galones, IdVehiculo = $this->idvehiculo, idusuario = $this->idusuario";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
          ...
          $this->detalle_movilizacion = $this->detalle_movilizacion_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['db_changed'] = true;
              ...
              $this->nmgp_refresh_fields = array_diff(array('id_movilizacion', 'movilizacion_fecha', 'idusuario', 'idvehiculo', 'km_galon', 'movilizacion_funcionario', 'movilizacion_hora_salida', 'movilizacion_km_salida', 'movilizacion_hora_llegada', 'movilizacion_km_llegada', 'movilizacion_costo_galon', 'movilizacion_cant_km_adicional', 'movilizacion_recorrido_vehiculo', 'movilizacion_total_km_recorrido', 'movilizacion_excedente', 'movilizacion_total_galones', 'detalle_movilizacion'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (movilizacion_funcionario, Movilizacion_Fecha, Movilizacion_Ruta, Movilizacion_Hora_Salida, Movilizacion_Hora_Llegada, Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, movilizacion_cant_km_adicional, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo, idusuario) VALUES ('$this->movilizacion_funcionario', #$this->movilizacion_fecha#, '$this->movilizacion_ruta', #$this->movilizacion_hora_salida#, #$this->movilizacion_hora_llegada#, $this->movilizacion_km_salida, $this->movilizacion_km_llegada, $this->movilizacion_costo_galon, $this->movilizacion_cant_km_adicional, $this->movilizacion_total_km_recorrido, $this->movilizacion_recorrido_vehiculo, $this->movilizacion_excedente, $this->movilizacion_total_galones, $this->idvehiculo, $this->idusuario)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "movilizacion_funcionario, Movilizacion_Fecha, Movilizacion_Ruta, Movilizacion_Hora_Salida, Movilizacion_Hora_Llegada, Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, movilizacion_cant_km_adicional, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo, idusuario) VALUES (" . $NM_seq_auto . "'$this->movilizacion_funcionario', " . $this->Ini->date_delim . $this->movilizacion_fecha . $this->Ini->date_delim1 . ", '$this->movilizacion_ruta', " . $this->Ini->date_delim . $this->movilizacion_hora_salida . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->movilizacion_hora_llegada . $this->Ini->date_delim1 . ", $this->movilizacion_km_salida, $this->movilizacion_km_llegada, $this->movilizacion_costo_galon, $this->movilizacion_cant_km_adicional, $this->movilizacion_total_km_recorrido, $this->movilizacion_recorrido_vehiculo, $this->movilizacion_excedente, $this->movilizacion_total_galones, $this->idvehiculo, $this->idusuario)"; 
              }
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "movilizacion_funcionario, Movilizacion_Fecha, Movilizacion_Ruta, Movilizacion_Hora_Salida, Movilizacion_Hora_Llegada, Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, movilizacion_cant_km_adicional, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo, idusuario) VALUES (" . $NM_seq_auto . "'$this->movilizacion_funcionario', EXTEND('$this->movilizacion_fecha', YEAR TO DAY), '$this->movilizacion_ruta', " . $this->Ini->date_delim . $this->movilizacion_hora_salida . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->movilizacion_hora_llegada . $this->Ini->date_delim1 . ", $this->movilizacion_km_salida, $this->movilizacion_km_llegada, $this->movilizacion_costo_galon, $this->movilizacion_cant_km_adicional, $this->movilizacion_total_km_recorrido, $this->movilizacion_recorrido_vehiculo, $this->movilizacion_excedente, $this->movilizacion_total_galones, $this->idvehiculo, $this->idusuario)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "movilizacion_funcionario, Movilizacion_Fecha, Movilizacion_Ruta, Movilizacion_Hora_Salida, Movilizacion_Hora_Llegada, Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, movilizacion_cant_km_adicional, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo, idusuario) VALUES (" . $NM_seq_auto . "'$this->movilizacion_funcionario', " . $this->Ini->date_delim . $this->movilizacion_fecha . $this->Ini->date_delim1 . ", '$this->movilizacion_ruta', " . $this->Ini->date_delim . $this->movilizacion_hora_salida . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->movilizacion_hora_llegada . $this->Ini->date_delim1 . ", $this->movilizacion_km_salida, $this->movilizacion_km_llegada, $this->movilizacion_costo_galon, $this->movilizacion_cant_km_adicional, $this->movilizacion_total_km_recorrido, $this->movilizacion_recorrido_vehiculo, $this->movilizacion_excedente, $this->movilizacion_total_galones, $this->idvehiculo, $this->idusuario)"; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_detalle_movilizacion_mob->ini_controle();
              if ($this->form_detalle_movilizacion_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['parms'] = "id_movilizacion?#?$this->id_movilizacion?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_movilizacion_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['total'] = $qt_geral_reg_form_movilizacion_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_movilizacion))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_movilizacion_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start'] > $qt_geral_reg_form_movilizacion_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start'] = $qt_geral_reg_form_movilizacion_mob; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          { 
              $nmgp_select = "SELECT Id_Movilizacion, movilizacion_funcionario, str_replace (convert(char(10),Movilizacion_Fecha,102), '.', '-') + ' ' + convert(char(8),Movilizacion_Fecha,20), Movilizacion_Ruta, str_replace (convert(char(10),Movilizacion_Hora_Salida,102), '.', '-') + ' ' + convert(char(8),Movilizacion_Hora_Salida,20), str_replace (convert(char(10),Movilizacion_Hora_Llegada,102), '.', '-') + ' ' + convert(char(8),Movilizacion_Hora_Llegada,20), Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, movilizacion_cant_km_adicional, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo, idusuario from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT Id_Movilizacion, movilizacion_funcionario, convert(char(23),Movilizacion_Fecha,121), Movilizacion_Ruta, convert(char(23),Movilizacion_Hora_Salida,121), convert(char(23),Movilizacion_Hora_Llegada,121), Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, movilizacion_cant_km_adicional, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo, idusuario from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $nmgp_select = "SELECT Id_Movilizacion, movilizacion_funcionario, Movilizacion_Fecha, Movilizacion_Ruta, Movilizacion_Hora_Salida, Movilizacion_Hora_Llegada, Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, movilizacion_cant_km_adicional, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo, idusuario from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $nmgp_select = "SELECT Id_Movilizacion, movilizacion_funcionario, EXTEND(Movilizacion_Fecha, YEAR TO DAY), Movilizacion_Ruta, Movilizacion_Hora_Salida, Movilizacion_Hora_Llegada, Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, movilizacion_cant_km_adicional, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo, idusuario from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT Id_Movilizacion, movilizacion_funcionario, Movilizacion_Fecha, Movilizacion_Ruta, Movilizacion_Hora_Salida, Movilizacion_Hora_Llegada, Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, movilizacion_cant_km_adicional, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo, idusuario from " . $this->Ini->nm_tabela ; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->movilizacion_ruta = $rs->fields[3] ; 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['reg_start'] < $qt_geral_reg_form_movilizacion_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dados_select'];
                  $this->movilizacion_funcionario = $this->nmgp_dados_select['movilizacion_funcionario'];  
                  $this->movilizacion_fecha = $this->nmgp_dados_select['movilizacion_fecha'];  
                  $this->movilizacion_ruta = $this->nmgp_dados_select['movilizacion_ruta'];  
                  $this->movilizacion_hora_salida = $this->nmgp_dados_select['movilizacion_hora_salida'];  
                  $this->movilizacion_hora_llegada = $this->nmgp_dados_select['movilizacion_hora_llegada'];  
                  $this->movilizacion_km_salida = $this->nmgp_dados_select['movilizacion_km_salida'];  
                  $this->movilizacion_km_llegada = $this->nmgp_dados_select['movilizacion_km_llegada'];  
                  $this->movilizacion_costo_galon = $this->nmgp_dados_select['movilizacion_costo_galon'];  
                  $this->movilizacion_cant_km_adicional = $this->nmgp_dados_select['movilizacion_cant_km_adicional'];  
                  $this->movilizacion_total_km_recorrido = $this->nmgp_dados_select['movilizacion_total_km_recorrido'];  
                  $this->movilizacion_recorrido_vehiculo = $this->nmgp_dados_select['movilizacion_recorrido_vehiculo'];  
                  $this->movilizacion_excedente = $this->nmgp_dados_select['movilizacion_excedente'];  
                  $this->movilizacion_total_galones = $this->nmgp_dados_select['movilizacion_total_galones'];  
                  $this->idvehiculo = $this->nmgp_dados_select['idvehiculo'];  
                  $this->idusuario = $this->nmgp_dados_select['idusuario'];  
                  $this->detalle_movilizacion = $this->nmgp_dados_select['detalle_movilizacion'];  
              }
          }
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['foreign_key']))
          {
...
//-- 
      ...
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['form_detalle_movilizacion_mob_script_case_init'] ]['form_detalle_movilizacion_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
  }
// 
//-- 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_movilizacion_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_idvehiculo()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idvehiculo']))
{
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_movilizacion_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['total'] = $qt_geral_reg_form_movilizacion_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_movilizacion_mob_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_movilizacion_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_movilizacion_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
