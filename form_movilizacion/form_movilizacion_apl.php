...
//---
    ...
    {
        global $teste_validade;
               if (!empty($this->idvehiculo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['Lookup_idvehiculo']) && !in_array($this->idvehiculo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['Lookup_idvehiculo']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->km_galon) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['Lookup_km_galon']) && !in_array($this->km_galon, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['Lookup_km_galon']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_movilizacion_costo_galon(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->movilizacion_costo_galon, 12, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_movilizacion_excedente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->movilizacion_excedente, 12, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_movilizacion_total_galones(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->movilizacion_total_galones, 12, 0, 0, 0, "N") == false)  
              { 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['Lookup_idvehiculo']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['Lookup_idvehiculo'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['Lookup_idvehiculo']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['Lookup_idvehiculo'] = array(); 
}
if ($this->idusuario != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['Lookup_idvehiculo'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idvehiculo']['valList'][$i] = form_movilizacion_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['Lookup_km_galon']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['Lookup_km_galon'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['Lookup_km_galon']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['Lookup_km_galon'] = array(); 
}
if ($this->idusuario != "")
{ 
   $this->nm_clear_val("idusuario");
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['Lookup_km_galon'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['km_galon']['valList'][$i] = form_movilizacion_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
