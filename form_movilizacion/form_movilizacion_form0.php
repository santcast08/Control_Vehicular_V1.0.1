...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_km_galon_label" id="hidden_field_label_km_galon" style="<?php echo $sStyleHidden_km_galon; ?>"><span id="id_label_km_galon"><?php echo $this->nm_new_label['km_galon']; ?></span></TD>
    <TD class="scFormDataOdd css_km_galon_line" id="hidden_field_data_km_galon" style="<?php echo $sStyleHidden_km_galon; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_km_galon_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_movilizacion_hora_salida_label" id="hidden_field_label_movilizacion_hora_salida" style="<?php echo $sStyleHidden_movilizacion_hora_salida; ?>"><span id="id_label_movilizacion_hora_salida"><?php echo $this->nm_new_label['movilizacion_hora_salida']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_movilizacion_hora_llegada_label" id="hidden_field_label_movilizacion_hora_llegada" style="<?php echo $sStyleHidden_movilizacion_hora_llegada; ?>"><span id="id_label_movilizacion_hora_llegada"><?php echo $this->nm_new_label['movilizacion_hora_llegada']; ?></span></TD>
    <TD class="scFormDataOdd css_movilizacion_hora_llegada_line" id="hidden_field_data_movilizacion_hora_llegada" style="<?php echo $sStyleHidden_movilizacion_hora_llegada; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_hora_llegada_line" style="vertical-align: top;padding: 0px">
