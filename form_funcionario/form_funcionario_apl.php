...
class form_funcionario_apl
{
   ...
   var $usuario_dependencia_1;
   var $usuario_cargo;
   var $usuario_cargo_1;
   var $usuario_estado;
   var $usuario_estado_1;
   var $nm_data;
   var $nmgp_opcao;
   var $nmgp_opc_ant;
   var $sc_evento;
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['usuario_apellidos']))
          {
              $this->usuario_apellidos = $this->NM_ajax_info['param']['usuario_apellidos'];
          }
          if (isset($this->NM_ajax_info['param']['usuario_cargo']))
          {
              $this->usuario_cargo = $this->NM_ajax_info['param']['usuario_cargo'];
          }
          if (isset($this->NM_ajax_info['param']['usuario_cedula']))
          {
              $this->usuario_cedula = $this->NM_ajax_info['param']['usuario_cedula'];
          }
          if (isset($this->NM_ajax_info['param']['usuario_correo']))
          {
              $this->usuario_correo = $this->NM_ajax_info['param']['usuario_correo'];
          }
          if (isset($this->NM_ajax_info['param']['usuario_dependencia']))
          {
              $this->usuario_dependencia = $this->NM_ajax_info['param']['usuario_dependencia'];
          }
          if (isset($this->NM_ajax_info['param']['usuario_estado']))
          {
              $this->usuario_estado = $this->NM_ajax_info['param']['usuario_estado'];
          }
          if (isset($this->NM_ajax_info['param']['usuario_nombres']))
          {
              $this->usuario_nombres = $this->NM_ajax_info['param']['usuario_nombres'];
          }
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_funcionario']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_funcionario']['label'] = "Ingreso de datos del funcionario";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_form']))
      {
          ...
          if (!isset($this->idusuario)){$this->idusuario = $this->nmgp_dados_form['idusuario'];} 
      }
...
//
      ...
      if (isset($this->usuario_cedula)) { $this->nm_limpa_alfa($this->usuario_cedula); }
      if (isset($this->usuario_nombres)) { $this->nm_limpa_alfa($this->usuario_nombres); }
      if (isset($this->usuario_apellidos)) { $this->nm_limpa_alfa($this->usuario_apellidos); }
      if (isset($this->usuario_correo)) { $this->nm_limpa_alfa($this->usuario_correo); }
      if (isset($this->usuario_dependencia)) { $this->nm_limpa_alfa($this->usuario_dependencia); }
      if (isset($this->usuario_cargo)) { $this->nm_limpa_alfa($this->usuario_cargo); }
      if (isset($this->usuario_estado)) { $this->nm_limpa_alfa($this->usuario_estado); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
   ...
   function loadFieldConfig()
   {
      ...
      //-- usuario_cedula
      $this->field_config['usuario_cedula']               = array();
      $this->field_config['usuario_cedula']['symbol_grp'] = '';
      $this->field_config['usuario_cedula']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['usuario_cedula']['symbol_dec'] = '';
      $this->field_config['usuario_cedula']['symbol_neg'] = '';
      $this->field_config['usuario_cedula']['format_neg'] = '2';
      //-- idusuario
...
//
      ...
      {
          if ('validate_usuario_cedula' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'usuario_cedula');
          }
          if ('validate_usuario_nombres' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'usuario_nombres');
          }
          if ('validate_usuario_apellidos' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'usuario_apellidos');
          }
          if ('validate_usuario_correo' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'usuario_correo');
          }
          if ('validate_usuario_cargo' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'usuario_cargo');
          }
          if ('validate_usuario_dependencia' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'usuario_dependencia');
          }
          if ('validate_usuario_estado' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'usuario_estado');
          }
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
      ...
      if ('' == $filtro || 'usuario_cedula' == $filtro)
        $this->ValidateField_usuario_cedula($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'usuario_nombres' == $filtro)
        $this->ValidateField_usuario_nombres($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'usuario_apellidos' == $filtro)
        $this->ValidateField_usuario_apellidos($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'usuario_correo' == $filtro)
        $this->ValidateField_usuario_correo($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'usuario_cargo' == $filtro)
        $this->ValidateField_usuario_cargo($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'usuario_dependencia' == $filtro)
        $this->ValidateField_usuario_dependencia($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'usuario_estado' == $filtro)
        $this->ValidateField_usuario_estado($Campos_Crit, $Campos_Falta, $Campos_Erros);
    ...
    function ValidateField_usuario_cedula(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->usuario_cedula == "")  
      { 
          $this->usuario_cedula = 0;
          $this->sc_force_zero[] = 'usuario_cedula';
      } 
      nm_limpa_numero($this->usuario_cedula, $this->field_config['usuario_cedula']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->usuario_cedula != '')  
          { 
              $iTestSize = 10;
              if (strlen($this->usuario_cedula) > $iTestSize)  
              { 
                  $Campos_Crit .= "Cedula: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['usuario_cedula']))
                  {
                      $Campos_Erros['usuario_cedula'] = array();
                  }
                  $Campos_Erros['usuario_cedula'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['usuario_cedula']) || !is_array($this->NM_ajax_info['errList']['usuario_cedula']))
                  {
                      $this->NM_ajax_info['errList']['usuario_cedula'] = array();
                  }
                  $this->NM_ajax_info['errList']['usuario_cedula'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->usuario_cedula, 10, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Cedula; " ; 
                  if (!isset($Campos_Erros['usuario_cedula']))
                  {
                  ...
                  $Campos_Erros['usuario_cedula'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['usuario_cedula']) || !is_array($this->NM_ajax_info['errList']['usuario_cedula']))
                  {
                      $this->NM_ajax_info['errList']['usuario_cedula'] = array();
                  }
                  $this->NM_ajax_info['errList']['usuario_cedula'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_usuario_cedula

    function ValidateField_usuario_nombres(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      $this->usuario_nombres = sc_strtoupper($this->usuario_nombres); 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->usuario_nombres) > 120) 
          { 
              $Campos_Crit .= "Nombres " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['usuario_nombres']))
              {
                  $Campos_Erros['usuario_nombres'] = array();
              }
              $Campos_Erros['usuario_nombres'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['usuario_nombres']) || !is_array($this->NM_ajax_info['errList']['usuario_nombres']))
              {
                  $this->NM_ajax_info['errList']['usuario_nombres'] = array();
              }
              $this->NM_ajax_info['errList']['usuario_nombres'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_usuario_nombres

    function ValidateField_usuario_apellidos(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      $this->usuario_apellidos = sc_strtoupper($this->usuario_apellidos); 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->usuario_apellidos) > 120) 
          { 
              $Campos_Crit .= "Apellidos " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['usuario_apellidos']))
              {
                  $Campos_Erros['usuario_apellidos'] = array();
              }
              $Campos_Erros['usuario_apellidos'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['usuario_apellidos']) || !is_array($this->NM_ajax_info['errList']['usuario_apellidos']))
              {
                  $this->NM_ajax_info['errList']['usuario_apellidos'] = array();
              }
              $this->NM_ajax_info['errList']['usuario_apellidos'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_usuario_apellidos

    function ValidateField_usuario_correo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      $this->usuario_correo = sc_strtoupper($this->usuario_correo); 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->usuario_correo) > 120) 
          { 
              $Campos_Crit .= "Correo " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['usuario_correo']))
              {
                  $Campos_Erros['usuario_correo'] = array();
              }
              $Campos_Erros['usuario_correo'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['usuario_correo'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_usuario_correo

    function ValidateField_usuario_cargo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
               if (!empty($this->usuario_cargo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_cargo']) && !in_array($this->usuario_cargo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_cargo']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['usuario_cargo']))
                   {
                       $Campos_Erros['usuario_cargo'] = array();
                   }
                   $Campos_Erros['usuario_cargo'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['usuario_cargo']) || !is_array($this->NM_ajax_info['errList']['usuario_cargo']))
                   {
                       $this->NM_ajax_info['errList']['usuario_cargo'] = array();
                   }
                   $this->NM_ajax_info['errList']['usuario_cargo'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
    } // ValidateField_usuario_cargo

    function ValidateField_usuario_dependencia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
               if (!empty($this->usuario_dependencia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_dependencia']) && !in_array($this->usuario_dependencia, $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_dependencia']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['usuario_dependencia']))
                   {
                       $Campos_Erros['usuario_dependencia'] = array();
                   }
                   $Campos_Erros['usuario_dependencia'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['usuario_dependencia']) || !is_array($this->NM_ajax_info['errList']['usuario_dependencia']))
                   {
                       $this->NM_ajax_info['errList']['usuario_dependencia'] = array();
                   }
                   $this->NM_ajax_info['errList']['usuario_dependencia'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
    } // ValidateField_usuario_dependencia

    function ValidateField_usuario_estado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->usuario_estado == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
    } // ValidateField_usuario_estado
   ...
   function nm_guardar_campos()
   {
    global
           $sc_seq_vert;
    $this->nmgp_dados_form['usuario_cedula'] = $this->usuario_cedula;
    $this->nmgp_dados_form['usuario_nombres'] = $this->usuario_nombres;
    $this->nmgp_dados_form['usuario_apellidos'] = $this->usuario_apellidos;
    $this->nmgp_dados_form['usuario_correo'] = $this->usuario_correo;
    $this->nmgp_dados_form['usuario_cargo'] = $this->usuario_cargo;
    $this->nmgp_dados_form['usuario_dependencia'] = $this->usuario_dependencia;
    $this->nmgp_dados_form['usuario_estado'] = $this->usuario_estado;
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if ('' !== $this->usuario_cedula || (!empty($format_fields) && isset($format_fields['usuario_cedula'])))
      {
          nmgp_Form_Num_Val($this->usuario_cedula, $this->field_config['usuario_cedula']['symbol_grp'], $this->field_config['usuario_cedula']['symbol_dec'], "0", "S", $this->field_config['usuario_cedula']['format_neg'], "", "", "-", $this->field_config['usuario_cedula']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   {
          $this->ajax_return_values_usuario_cedula();
          $this->ajax_return_values_usuario_nombres();
          $this->ajax_return_values_usuario_apellidos();
          $this->ajax_return_values_usuario_correo();
          $this->ajax_return_values_usuario_cargo();
          $this->ajax_return_values_usuario_dependencia();
          $this->ajax_return_values_usuario_estado();
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              $this->NM_ajax_info['clearUpload']      = 'S';
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['idusuario']['keyVal'] = form_funcionario_pack_protect_string($this->nmgp_dados_form['idusuario']);
          }
   } // ajax_return_values

          //----- usuario_cedula
   function ajax_return_values_usuario_cedula($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("usuario_cedula", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->usuario_cedula);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['usuario_cedula'] = array(
                       'row'    => '',
               'type'    => 'text',
          ...
          //----- usuario_nombres
   function ajax_return_values_usuario_nombres($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("usuario_nombres", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->usuario_nombres);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['usuario_nombres'] = array(
                       'row'    => '',
               'type'    => 'text',
          ...
          //----- usuario_apellidos
   function ajax_return_values_usuario_apellidos($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("usuario_apellidos", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->usuario_apellidos);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['usuario_apellidos'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
   ...
   function ajax_return_values_usuario_correo($bForce = false)
   {
          ...
          //----- usuario_cargo
   function ajax_return_values_usuario_cargo($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("usuario_cargo", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->usuario_cargo);
              $aLookup = array();
              $this->_tmp_lookup_usuario_cargo = $this->usuario_cargo;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_cargo']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_cargo'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_cargo']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_cargo'] = array(); 
}
$aLookup[] = array(form_funcionario_pack_protect_string('') => form_funcionario_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_cargo'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_cargo'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"usuario_cargo\"";
          if (isset($this->NM_ajax_info['select_html']['usuario_cargo']) && !empty($this->NM_ajax_info['select_html']['usuario_cargo']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['usuario_cargo'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->usuario_cargo == $sValue)
                  {
                      $this->_tmp_lookup_usuario_cargo = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['usuario_cargo'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['usuario_cargo']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['usuario_cargo']['valList'][$i] = form_funcionario_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['usuario_cargo']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['usuario_cargo']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['usuario_cargo']['labList'] = $aLabel;
          }
   }

          //----- usuario_dependencia
   function ajax_return_values_usuario_dependencia($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("usuario_dependencia", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->usuario_dependencia);
              $aLookup = array();
              $this->_tmp_lookup_usuario_dependencia = $this->usuario_dependencia;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_dependencia']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_dependencia'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_dependencia']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_dependencia'] = array(); 
}
$aLookup[] = array(form_funcionario_pack_protect_string('') => form_funcionario_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_dependencia'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_dependencia'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"usuario_dependencia\"";
          if (isset($this->NM_ajax_info['select_html']['usuario_dependencia']) && !empty($this->NM_ajax_info['select_html']['usuario_dependencia']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['usuario_dependencia'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->usuario_dependencia == $sValue)
                  {
                      $this->_tmp_lookup_usuario_dependencia = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['usuario_dependencia'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['usuario_dependencia']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['usuario_dependencia']['valList'][$i] = form_funcionario_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['usuario_dependencia']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['usuario_dependencia']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['usuario_dependencia']['labList'] = $aLabel;
          }
   }

          //----- usuario_estado
   function ajax_return_values_usuario_estado($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("usuario_estado", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->usuario_estado);
              $aLookup = array();
              $this->_tmp_lookup_usuario_estado = $this->usuario_estado;

$aLookup[] = array(form_funcionario_pack_protect_string('ACTIVO') => form_funcionario_pack_protect_string("ACTIVO"));
$aLookup[] = array(form_funcionario_pack_protect_string('INACTIVO') => form_funcionario_pack_protect_string("INACTIVO"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_estado'][] = 'ACTIVO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_estado'][] = 'INACTIVO';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"usuario_estado\"";
          if (isset($this->NM_ajax_info['select_html']['usuario_estado']) && !empty($this->NM_ajax_info['select_html']['usuario_estado']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['usuario_estado'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->usuario_estado == $sValue)
                  {
                      $this->_tmp_lookup_usuario_estado = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['usuario_estado'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['usuario_estado']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['usuario_estado']['valList'][$i] = form_funcionario_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['usuario_estado']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['usuario_estado']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['usuario_estado']['labList'] = $aLabel;
          }
   }
...
$check_table = 'my_table';    
$check_where = "field = 'condition'"; 
...
//----------- 
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      ...
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM dependencia WHERE usuario_idusuario = " . $this->idusuario ;
      }
      ...
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->dataset_dependencia = array();
      ...
      { 
          ...
          { 
                 ...
                 { 
                      $this->dataset_dependencia[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dataset_dependencia = false;
          $this->dataset_dependencia_erro = $this->Db->ErrorMsg();
      } 
;

      if($this->dataset_dependencia[0][0] > 0)
      {
...
;
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM historial_asignacion WHERE usuario_idusuario = " . $this->idusuario ;
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM historial_asignacion WHERE usuario_idusuario = " . $this->idusuario ;
      ...
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->dataset_historial_asignacion = array();
      if ($rx = $this->Db->Execute($nm_select)) 
      { 
          $y = 0; 
          $nm_count = $rx->FieldCount();
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                      $this->dataset_historial_asignacion[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dataset_historial_asignacion = false;
          $this->dataset_historial_asignacion_erro = $this->Db->ErrorMsg();
      } 
;

      if($this->dataset_historial_asignacion[0][0] > 0)
      {
...
;
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM vehiculos WHERE usuario_idusuario = " . $this->idusuario ;
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM vehiculos WHERE usuario_idusuario = " . $this->idusuario ;
      ...
      { 
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                      $this->dataset_vehiculos[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dataset_vehiculos = false;
          $this->dataset_vehiculos_erro = $this->Db->ErrorMsg();
      } 
;

      if($this->dataset_vehiculos[0][0] > 0)
      {
...
$_SESSION['scriptcase']['form_funcionario']['contr_erro'] = 'off'; 
      ...
      $NM_val_form['usuario_cedula'] = $this->usuario_cedula;
      $NM_val_form['usuario_nombres'] = $this->usuario_nombres;
      $NM_val_form['usuario_apellidos'] = $this->usuario_apellidos;
      $NM_val_form['usuario_correo'] = $this->usuario_correo;
      $NM_val_form['usuario_cargo'] = $this->usuario_cargo;
      $NM_val_form['usuario_dependencia'] = $this->usuario_dependencia;
      $NM_val_form['usuario_estado'] = $this->usuario_estado;
      ...
      {
          $this->usuario_nombres_before_qstr = $this->usuario_nombres;
          $this->usuario_nombres = substr($this->Db->qstr($this->usuario_nombres), 1, -1); 
          if ($this->usuario_nombres == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->usuario_nombres = "null"; 
              $NM_val_null[] = "usuario_nombres";
          } 
          $this->usuario_apellidos_before_qstr = $this->usuario_apellidos;
          $this->usuario_apellidos = substr($this->Db->qstr($this->usuario_apellidos), 1, -1); 
          if ($this->usuario_apellidos == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->usuario_apellidos = "null"; 
              $NM_val_null[] = "usuario_apellidos";
          } 
          ...
          $this->usuario_dependencia_before_qstr = $this->usuario_dependencia;
          $this->usuario_dependencia = substr($this->Db->qstr($this->usuario_dependencia), 1, -1); 
          if ($this->usuario_dependencia == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->usuario_dependencia = "null"; 
              $NM_val_null[] = "usuario_dependencia";
          } 
          $this->usuario_cargo_before_qstr = $this->usuario_cargo;
          $this->usuario_cargo = substr($this->Db->qstr($this->usuario_cargo), 1, -1); 
          if ($this->usuario_cargo == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->usuario_cargo = "null"; 
              $NM_val_null[] = "usuario_cargo";
          } 
          $this->usuario_estado_before_qstr = $this->usuario_estado;
          $this->usuario_estado = substr($this->Db->qstr($this->usuario_estado), 1, -1); 
          if ($this->usuario_estado == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->usuario_estado = "null"; 
              $NM_val_null[] = "usuario_estado";
          } 
      }
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET usuario_cedula = $this->usuario_cedula, usuario_nombres = '$this->usuario_nombres', usuario_apellidos = '$this->usuario_apellidos', usuario_correo = '$this->usuario_correo', usuario_dependencia = '$this->usuario_dependencia', usuario_cargo = '$this->usuario_cargo', usuario_estado = '$this->usuario_estado'";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET usuario_cedula = $this->usuario_cedula, usuario_nombres = '$this->usuario_nombres', usuario_apellidos = '$this->usuario_apellidos', usuario_correo = '$this->usuario_correo', usuario_dependencia = '$this->usuario_dependencia', usuario_cargo = '$this->usuario_cargo', usuario_estado = '$this->usuario_estado'";  
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET usuario_cedula = $this->usuario_cedula, usuario_nombres = '$this->usuario_nombres', usuario_apellidos = '$this->usuario_apellidos', usuario_correo = '$this->usuario_correo', usuario_dependencia = '$this->usuario_dependencia', usuario_cargo = '$this->usuario_cargo', usuario_estado = '$this->usuario_estado'";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET usuario_cedula = $this->usuario_cedula, usuario_nombres = '$this->usuario_nombres', usuario_apellidos = '$this->usuario_apellidos', usuario_correo = '$this->usuario_correo', usuario_dependencia = '$this->usuario_dependencia', usuario_cargo = '$this->usuario_cargo', usuario_estado = '$this->usuario_estado'";  
          ...
          $this->usuario_nombres = $this->usuario_nombres_before_qstr;
          $this->usuario_apellidos = $this->usuario_apellidos_before_qstr;
          $this->usuario_correo = $this->usuario_correo_before_qstr;
          $this->usuario_dependencia = $this->usuario_dependencia_before_qstr;
          $this->usuario_cargo = $this->usuario_cargo_before_qstr;
          $this->usuario_estado = $this->usuario_estado_before_qstr;
              $this->sc_evento = "update"; 
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['usuario_cedula'])) { $this->usuario_cedula = $NM_val_form['usuario_cedula']; }
              elseif (isset($this->usuario_cedula)) { $this->nm_limpa_alfa($this->usuario_cedula); }
              if     (isset($NM_val_form) && isset($NM_val_form['usuario_nombres'])) { $this->usuario_nombres = $NM_val_form['usuario_nombres']; }
              elseif (isset($this->usuario_nombres)) { $this->nm_limpa_alfa($this->usuario_nombres); }
              if     (isset($NM_val_form) && isset($NM_val_form['usuario_apellidos'])) { $this->usuario_apellidos = $NM_val_form['usuario_apellidos']; }
              elseif (isset($this->usuario_apellidos)) { $this->nm_limpa_alfa($this->usuario_apellidos); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['usuario_dependencia'])) { $this->usuario_dependencia = $NM_val_form['usuario_dependencia']; }
              elseif (isset($this->usuario_dependencia)) { $this->nm_limpa_alfa($this->usuario_dependencia); }
              if     (isset($NM_val_form) && isset($NM_val_form['usuario_cargo'])) { $this->usuario_cargo = $NM_val_form['usuario_cargo']; }
              elseif (isset($this->usuario_cargo)) { $this->nm_limpa_alfa($this->usuario_cargo); }
              if     (isset($NM_val_form) && isset($NM_val_form['usuario_estado'])) { $this->usuario_estado = $NM_val_form['usuario_estado']; }
              elseif (isset($this->usuario_estado)) { $this->nm_limpa_alfa($this->usuario_estado); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('usuario_cedula', 'usuario_nombres', 'usuario_apellidos', 'usuario_correo', 'usuario_cargo', 'usuario_dependencia', 'usuario_estado'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (usuario_cedula, usuario_nombres, usuario_apellidos, usuario_correo, usuario_dependencia, usuario_cargo, usuario_estado) VALUES ($this->usuario_cedula, '$this->usuario_nombres', '$this->usuario_apellidos', '$this->usuario_correo', '$this->usuario_dependencia', '$this->usuario_cargo', '$this->usuario_estado')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "usuario_cedula, usuario_nombres, usuario_apellidos, usuario_correo, usuario_dependencia, usuario_cargo, usuario_estado) VALUES (" . $NM_seq_auto . "$this->usuario_cedula, '$this->usuario_nombres', '$this->usuario_apellidos', '$this->usuario_correo', '$this->usuario_dependencia', '$this->usuario_cargo', '$this->usuario_estado')"; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['parms'] = "idusuario?#?$this->idusuario?@?"; 
      }
      $this->NM_commit_db(); 
...
//------------ 
      ...
      if ($this->nmgp_opcao != "nada" && (trim($this->idusuario) == "")) 
      { 
      ...
      { 
          ...
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idusuario))
          {
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $Key_Where = "idusuario < $this->idusuario "; 
              }  
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              {
                  $Key_Where = "idusuario < $this->idusuario "; 
...
//---------- 
      ...
      { 
          ...
          { 
              $nmgp_select = "SELECT idusuario, usuario_cedula, usuario_nombres, usuario_apellidos, usuario_correo, usuario_dependencia, usuario_cargo, usuario_estado from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT idusuario, usuario_cedula, usuario_nombres, usuario_apellidos, usuario_correo, usuario_dependencia, usuario_cargo, usuario_estado from " . $this->Ini->nm_tabela ; 
          ...
          { 
              ...
              $this->usuario_cedula = $rs->fields[1] ; 
              $this->nmgp_dados_select['usuario_cedula'] = $this->usuario_cedula;
              $this->usuario_nombres = $rs->fields[2] ; 
              $this->nmgp_dados_select['usuario_nombres'] = $this->usuario_nombres;
              $this->usuario_apellidos = $rs->fields[3] ; 
              $this->nmgp_dados_select['usuario_apellidos'] = $this->usuario_apellidos;
              ...
              $this->nmgp_dados_select['usuario_dependencia'] = $this->usuario_dependencia;
              $this->usuario_cargo = $rs->fields[6] ; 
              $this->nmgp_dados_select['usuario_cargo'] = $this->usuario_cargo;
              $this->usuario_estado = $rs->fields[7] ; 
              $this->nmgp_dados_select['usuario_estado'] = $this->usuario_estado;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
...
//-- 
   ...
   {  
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(idusuario) from " . $this->Ini->nm_tabela . " where idusuario < $this->idusuario" . $str_where_filter; 
         $rs = $this->Db->Execute("select max(idusuario) from " . $this->Ini->nm_tabela . " where idusuario < $this->idusuario" . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(idusuario) from " . $this->Ini->nm_tabela . " where idusuario < $this->idusuario" . $str_where_filter; 
     ...
     { 
         $this->idusuario = substr($this->Db->qstr($rs->fields[0]), 1, -1); 
         $rs->Close();  
         $this->nmgp_opcao = "igual";  
         return ;  
     } 
...
//-- 
   ...
   {  
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(idusuario) from " . $this->Ini->nm_tabela . " where idusuario > $this->idusuario" . $str_where_filter; 
         $rs = $this->Db->Execute("select min(idusuario) from " . $this->Ini->nm_tabela . " where idusuario > $this->idusuario" . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(idusuario) from " . $this->Ini->nm_tabela . " where idusuario > $this->idusuario" . $str_where_filter; 
...
//-- 
   ...
   {   
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(idusuario) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select min(idusuario) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(idusuario) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
...
//-- 
   ...
   { 
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(idusuario) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select max(idusuario) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(idusuario) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
...
<?php
 ...
 function new_date_format($type, $field)
 {
   ...
   function Form_lookup_usuario_cargo()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_cargo']))
{
...
else
{
   ...
   function Form_lookup_usuario_dependencia()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_usuario_dependencia']))
{
...
else
{
   ...
   function Form_lookup_usuario_estado()
   {
       $nmgp_def_dados  = "";
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $data_lookup = $this->SC_lookup_usuario_estado($arg_search, $data_search);
          if (is_array($data_lookup) && !empty($data_lookup)) 
          {
              $this->SC_monta_condicao($comando, "usuario_estado", $arg_search, $data_lookup);
          }
      }
   ...
   function SC_lookup_usuario_estado($condicao, $campo)
   {
       $data_look = array();
       $campo  = substr($this->Db->qstr($campo), 1, -1);
