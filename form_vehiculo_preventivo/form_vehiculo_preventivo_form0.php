...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Ingreso de datos del mantenimiento preventivo"); } else { echo strip_tags("Ingreso de datos del mantenimiento preventivo"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['embutida_pdf']))
 {
 ?>
<?php
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_vehiculo_preventivo/form_vehiculo_preventivo_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_vehiculo_preventivo_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_vehiculo_preventivo_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['recarga'];
}
?>
...
<?php
 include_once("form_vehiculo_preventivo_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_vehiculo_preventivo'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_vehiculo_preventivo'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "Ingreso de datos del mantenimiento preventivo"; } else { echo "Ingreso de datos del mantenimiento preventivo"; } ?></span></td>
...
?>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bprint", "scBtnFn_sys_format_imp()", "scBtnFn_sys_format_imp()", "sc_b_prt_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-1", "", "");?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
   ...
   {
       $this->nm_new_label['usuario_idusuario'] = "Usuario";
   }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_usuario_idusuario_line" id="hidden_field_data_usuario_idusuario" style="<?php echo $sStyleHidden_usuario_idusuario; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_usuario_idusuario_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_usuario_idusuario_label"><span id="id_label_usuario_idusuario"><?php echo $this->nm_new_label['usuario_idusuario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['usuario_idusuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['usuario_idusuario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_placa_line" id="hidden_field_data_vehiculo_placa" style="<?php echo $sStyleHidden_vehiculo_placa; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_placa_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_placa_label"><span id="id_label_vehiculo_placa"><?php echo $this->nm_new_label['vehiculo_placa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_placa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_placa'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_usuario_idusuario_dumb = ('' == $sStyleHidden_usuario_idusuario) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_usuario_idusuario_dumb" style="<?php echo $sStyleHidden_usuario_idusuario_dumb; ?>"></TD>
<?php $sStyleHidden_vehiculo_placa_dumb = ('' == $sStyleHidden_vehiculo_placa) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vehiculo_placa_dumb" style="<?php echo $sStyleHidden_vehiculo_placa_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_marca_line" id="hidden_field_data_vehiculo_marca" style="<?php echo $sStyleHidden_vehiculo_marca; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_marca_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_marca_label"><span id="id_label_vehiculo_marca"><?php echo $this->nm_new_label['vehiculo_marca']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_marca']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_marca'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_vehiculo_matricula_dumb = ('' == $sStyleHidden_vehiculo_matricula) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vehiculo_matricula_dumb" style="<?php echo $sStyleHidden_vehiculo_matricula_dumb; ?>"></TD>
<?php $sStyleHidden_vehiculo_marca_dumb = ('' == $sStyleHidden_vehiculo_marca) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vehiculo_marca_dumb" style="<?php echo $sStyleHidden_vehiculo_marca_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_modelo_line" id="hidden_field_data_vehiculo_modelo" style="<?php echo $sStyleHidden_vehiculo_modelo; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_modelo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_modelo_label"><span id="id_label_vehiculo_modelo"><?php echo $this->nm_new_label['vehiculo_modelo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_modelo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_modelo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_color_line" id="hidden_field_data_vehiculo_color" style="<?php echo $sStyleHidden_vehiculo_color; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_color_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_color_label"><span id="id_label_vehiculo_color"><?php echo $this->nm_new_label['vehiculo_color']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_color']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_color'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_vehiculo_modelo_dumb = ('' == $sStyleHidden_vehiculo_modelo) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vehiculo_modelo_dumb" style="<?php echo $sStyleHidden_vehiculo_modelo_dumb; ?>"></TD>
<?php $sStyleHidden_vehiculo_color_dumb = ('' == $sStyleHidden_vehiculo_color) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vehiculo_color_dumb" style="<?php echo $sStyleHidden_vehiculo_color_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_chasis_line" id="hidden_field_data_vehiculo_chasis" style="<?php echo $sStyleHidden_vehiculo_chasis; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_chasis_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_chasis_label"><span id="id_label_vehiculo_chasis"><?php echo $this->nm_new_label['vehiculo_chasis']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_chasis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_chasis'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_vehiculo_chasis_dumb = ('' == $sStyleHidden_vehiculo_chasis) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vehiculo_chasis_dumb" style="<?php echo $sStyleHidden_vehiculo_chasis_dumb; ?>"></TD>
<?php $sStyleHidden_vehiculo_numero_motor_dumb = ('' == $sStyleHidden_vehiculo_numero_motor) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vehiculo_numero_motor_dumb" style="<?php echo $sStyleHidden_vehiculo_numero_motor_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_km_galon_line" id="hidden_field_data_vehiculo_km_galon" style="<?php echo $sStyleHidden_vehiculo_km_galon; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_km_galon_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_km_galon_label"><span id="id_label_vehiculo_km_galon"><?php echo $this->nm_new_label['vehiculo_km_galon']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_km_galon']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_km_galon'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_vehiculo_km_galon_dumb = ('' == $sStyleHidden_vehiculo_km_galon) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vehiculo_km_galon_dumb" style="<?php echo $sStyleHidden_vehiculo_km_galon_dumb; ?>"></TD>
<?php $sStyleHidden_vehiculo_km_inicial_dumb = ('' == $sStyleHidden_vehiculo_km_inicial) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vehiculo_km_inicial_dumb" style="<?php echo $sStyleHidden_vehiculo_km_inicial_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_tipo_combustible_line" id="hidden_field_data_vehiculo_tipo_combustible" style="<?php echo $sStyleHidden_vehiculo_tipo_combustible; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_tipo_combustible_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_tipo_combustible_label"><span id="id_label_vehiculo_tipo_combustible"><?php echo $this->nm_new_label['vehiculo_tipo_combustible']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_tipo_combustible']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_tipo_combustible'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_estado_line" id="hidden_field_data_vehiculo_estado" style="<?php echo $sStyleHidden_vehiculo_estado; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_estado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_estado_label"><span id="id_label_vehiculo_estado"><?php echo $this->nm_new_label['vehiculo_estado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_estado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['php_cmp_required']['vehiculo_estado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_vehiculo_tipo_combustible_dumb = ('' == $sStyleHidden_vehiculo_tipo_combustible) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vehiculo_tipo_combustible_dumb" style="<?php echo $sStyleHidden_vehiculo_tipo_combustible_dumb; ?>"></TD>
<?php $sStyleHidden_vehiculo_estado_dumb = ('' == $sStyleHidden_vehiculo_estado) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vehiculo_estado_dumb" style="<?php echo $sStyleHidden_vehiculo_estado_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } ?>
<?php $sStyleHidden_vehiculo_fechaasignacion_dumb = ('' == $sStyleHidden_vehiculo_fechaasignacion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vehiculo_fechaasignacion_dumb" style="<?php echo $sStyleHidden_vehiculo_fechaasignacion_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<TABLE align="center" id="hidden_bloco_1" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['preventivos']))
    {
        $this->nm_new_label['preventivos'] = "preventivos";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $preventivos = $this->preventivos;
   $sStyleHidden_preventivos = '';
   if (isset($this->nmgp_cmp_hidden['preventivos']) && $this->nmgp_cmp_hidden['preventivos'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['preventivos']);
       $sStyleHidden_preventivos = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_preventivos = 'display: none;';
   $sStyleReadInp_preventivos = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['preventivos']) && $this->nmgp_cmp_readonly['preventivos'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['preventivos']);
       $sStyleReadLab_preventivos = '';
       $sStyleReadInp_preventivos = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['preventivos']) && $this->nmgp_cmp_hidden['preventivos'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="preventivos" value="<?php echo $this->form_encode_input($preventivos) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_preventivos_line" id="hidden_field_data_preventivos" style="<?php echo $sStyleHidden_preventivos; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_preventivos_line" style="vertical-align: top;padding: 0px">
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_preventivos'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_preventivos'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_preventivos'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] ]['form_preventivo']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] ]['form_preventivo']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] ]['form_preventivo']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] ]['form_preventivo']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] ]['form_preventivo']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] ]['form_preventivo']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] ]['form_preventivo']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] ]['form_preventivo']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] ]['form_preventivo']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] ]['form_preventivo']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] ]['form_preventivo']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] ]['form_preventivo']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init'] ]['form_vehiculo_preventivo']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_vehiculo_preventivo_empty.htm' : $this->Ini->link_form_preventivo_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500';
if (isset($this->Ini->sc_lig_target['C_@scinf_preventivos']) && 'nmsc_iframe_liga_form_preventivo' != $this->Ini->sc_lig_target['C_@scinf_preventivos'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_preventivos'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['form_preventivo_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
    scOpenMasterDetail("<?php echo $this->Ini->sc_lig_target['C_@scinf_preventivos'] ?>", "<?php echo $sDetailSrc; ?>");
});
</script>
<?php
}
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_preventivo"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="500" width="100%" name="nmsc_iframe_liga_form_preventivo"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_preventivos_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_preventivos_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_preventivo']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_vehiculo_preventivo");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_vehiculo_preventivo");
 parent.scAjaxDetailHeight("form_vehiculo_preventivo", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_imp() {
		if ($("#sc_b_prt_t.sc-unique-btn-1").length && $("#sc_b_prt_t.sc-unique-btn-1").is(":visible")) {
			nm_gp_form_print()
			 return;
		}
	}
