...
<?php
   ...
   $Ord_Cmp = new grid_vehiculos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_vehiculos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['usuario_idusuario'] = "on";
   $tab_def_campos['usuario_idusuario'] = "usuario_idusuario";
   $tab_converte["usuario_idusuario"]   = "usuario_idusuario";
   $tab_labels["usuario_idusuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vehiculos']['labels']["usuario_idusuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_vehiculos']['labels']["usuario_idusuario"] : "Usuario ";
   $tab_ger_campos['vehiculo_placa'] = "on";
   $tab_def_campos['vehiculo_placa'] = "Vehiculo_Placa";
   $tab_converte["Vehiculo_Placa"]   = "vehiculo_placa";
   $tab_labels["vehiculo_placa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vehiculos']['labels']["vehiculo_placa"])) ? $_SESSION['sc_session'][$sc_init]['grid_vehiculos']['labels']["vehiculo_placa"] : "Placa";
   $tab_ger_campos['vehiculo_marca'] = "on";
   $tab_def_campos['vehiculo_marca'] = "Vehiculo_Marca";
   $tab_converte["Vehiculo_Marca"]   = "vehiculo_marca";
   $tab_labels["vehiculo_marca"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vehiculos']['labels']["vehiculo_marca"])) ? $_SESSION['sc_session'][$sc_init]['grid_vehiculos']['labels']["vehiculo_marca"] : "Marca";
   $tab_ger_campos['vehiculo_modelo'] = "on";
   $tab_def_campos['vehiculo_modelo'] = "Vehiculo_Modelo";
   $tab_converte["Vehiculo_Modelo"]   = "vehiculo_modelo";
   $tab_labels["vehiculo_modelo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vehiculos']['labels']["vehiculo_modelo"])) ? $_SESSION['sc_session'][$sc_init]['grid_vehiculos']['labels']["vehiculo_modelo"] : " Modelo";
   $tab_ger_campos['vehiculo_color'] = "on";
   $tab_def_campos['vehiculo_color'] = "Vehiculo_Color";
   $tab_converte["Vehiculo_Color"]   = "vehiculo_color";
   $tab_labels["vehiculo_color"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vehiculos']['labels']["vehiculo_color"])) ? $_SESSION['sc_session'][$sc_init]['grid_vehiculos']['labels']["vehiculo_color"] : "Color";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_vehiculos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_vehiculos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_vehiculos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vehiculos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vehiculos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_vehiculos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_vehiculos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_vehiculos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_vehiculos']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_vehiculos_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_vehiculos']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_vehiculos']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
