...
class grid_vehiculos_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_vehiculos.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vehiculos']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vehiculos']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vehiculos']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vehiculos']['rtf_name']);
      }
   ...
   function NM_export_usuario_idusuario()
   {
         ...
         $this->look_usuario_idusuario = str_replace('<', '&lt;', $this->look_usuario_idusuario);
         $this->look_usuario_idusuario = str_replace('>', '&gt;', $this->look_usuario_idusuario);
         $this->Texto_tag .= "<td>" . $this->look_usuario_idusuario . "</td>\r\n";
   }
   //----- vehiculo_placa
   function NM_export_vehiculo_placa()
   {
         ...
         $this->vehiculo_placa = str_replace('<', '&lt;', $this->vehiculo_placa);
         $this->vehiculo_placa = str_replace('>', '&gt;', $this->vehiculo_placa);
         $this->Texto_tag .= "<td>" . $this->vehiculo_placa . "</td>\r\n";
   }
   //----- vehiculo_marca
   function NM_export_vehiculo_marca()
   {
         ...
         $this->vehiculo_marca = str_replace('<', '&lt;', $this->vehiculo_marca);
         $this->vehiculo_marca = str_replace('>', '&gt;', $this->vehiculo_marca);
         $this->Texto_tag .= "<td>" . $this->vehiculo_marca . "</td>\r\n";
   }
   //----- vehiculo_modelo
   function NM_export_vehiculo_modelo()
   {
         ...
         $this->vehiculo_modelo = str_replace('<', '&lt;', $this->vehiculo_modelo);
         $this->vehiculo_modelo = str_replace('>', '&gt;', $this->vehiculo_modelo);
         $this->Texto_tag .= "<td>" . $this->vehiculo_modelo . "</td>\r\n";
   }
   //----- vehiculo_color
   function NM_export_vehiculo_color()
   {
         ...
         $this->vehiculo_color = str_replace('<', '&lt;', $this->vehiculo_color);
         $this->vehiculo_color = str_replace('>', '&gt;', $this->vehiculo_color);
         $this->Texto_tag .= "<td>" . $this->vehiculo_color . "</td>\r\n";
   }
   //----- idvehiculo
   function NM_export_idvehiculo()
   {
         ...
         $this->idvehiculo = str_replace('<', '&lt;', $this->idvehiculo);
         $this->idvehiculo = str_replace('>', '&gt;', $this->idvehiculo);
         $this->Texto_tag .= "<td>" . $this->idvehiculo . "</td>\r\n";
   }
   //----- vehiculo_matricula
   function NM_export_vehiculo_matricula()
   {
         ...
         $this->vehiculo_matricula = str_replace('<', '&lt;', $this->vehiculo_matricula);
         $this->vehiculo_matricula = str_replace('>', '&gt;', $this->vehiculo_matricula);
         $this->Texto_tag .= "<td>" . $this->vehiculo_matricula . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vehiculos']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vehiculos']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Información del Vehículo :: RTF</TITLE>
