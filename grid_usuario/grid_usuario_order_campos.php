...
<?php
   ...
   $Ord_Cmp = new grid_usuario_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_usuario_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['usuario_cedula'] = "on";
   $tab_def_campos['usuario_cedula'] = "usuario_cedula";
   $tab_converte["usuario_cedula"]   = "usuario_cedula";
   $tab_labels["usuario_cedula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuario_cedula"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuario_cedula"] : "Cedula";
   $tab_ger_campos['usuario_nombres'] = "on";
   $tab_def_campos['usuario_nombres'] = "usuario_nombres";
   $tab_converte["usuario_nombres"]   = "usuario_nombres";
   $tab_labels["usuario_nombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuario_nombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuario_nombres"] : "Nombres";
   $tab_ger_campos['usuario_apellidos'] = "on";
   $tab_def_campos['usuario_apellidos'] = "usuario_apellidos";
   $tab_converte["usuario_apellidos"]   = "usuario_apellidos";
   $tab_labels["usuario_apellidos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuario_apellidos"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuario_apellidos"] : "Apellidos";
   $tab_ger_campos['usuario_correo'] = "on";
   $tab_def_campos['usuario_correo'] = "usuario_correo";
   $tab_converte["usuario_correo"]   = "usuario_correo";
   $tab_labels["usuario_correo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuario_correo"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuario_correo"] : "Correo";
   $tab_ger_campos['usuario_cargo'] = "on";
   $tab_def_campos['usuario_cargo'] = "usuario_cargo";
   $tab_converte["usuario_cargo"]   = "usuario_cargo";
   $tab_labels["usuario_cargo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuario_cargo"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuario_cargo"] : "Cargo";
   $tab_ger_campos['usuario_dependencia'] = "on";
   $tab_def_campos['usuario_dependencia'] = "usuario_dependencia";
   $tab_converte["usuario_dependencia"]   = "usuario_dependencia";
   $tab_labels["usuario_dependencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuario_dependencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuario_dependencia"] : "Dependencia";
   $tab_ger_campos['usuario_estado'] = "on";
   $tab_def_campos['usuario_estado'] = "usuario_estado";
   $tab_converte["usuario_estado"]   = "usuario_estado";
   $tab_labels["usuario_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuario_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuario']['labels']["usuario_estado"] : "Estado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_usuario']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_usuario']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_usuario_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_usuario']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
