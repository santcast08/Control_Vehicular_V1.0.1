...
class grid_usuario_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_usuario" . $this->Xls_tp;
          $this->Tit_doc    = "grid_usuario" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['embutida_label'])
      { 
      ...
      while (!$rs->EOF)
      {
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['embutida'])
         { 
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['embutida'])
      { 
   ...
   function NM_export_usuario_cedula()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->usuario_cedula))
         {
             $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getNumberFormat()->setFormatCode('###0');
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->usuario_cedula);
         $this->Xls_col++;
   }
   //----- usuario_nombres
   function NM_export_usuario_nombres()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->usuario_nombres, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- usuario_apellidos
   function NM_export_usuario_apellidos()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->usuario_apellidos, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- usuario_correo
   ...
   function NM_export_usuario_cargo()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_usuario_cargo, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- usuario_dependencia
   function NM_export_usuario_dependencia()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_usuario_dependencia, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- usuario_estado
   function NM_export_usuario_estado()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->usuario_estado, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- idusuario
   function NM_export_idusuario()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->idusuario);
         $this->Xls_col++;
   }
   //----- usuario_cedula
   function NM_sub_cons_usuario_cedula()
   {
         if (!NM_is_utf8($this->usuario_cedula))
         {
             $this->usuario_cedula = sc_convert_encoding($this->usuario_cedula, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->usuario_cedula;
   ...
   //----- usuario_nombres
   function NM_sub_cons_usuario_nombres()
   {
         $this->usuario_nombres = html_entity_decode($this->usuario_nombres, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->usuario_nombres = strip_tags($this->usuario_nombres);
         if (!NM_is_utf8($this->usuario_nombres))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->usuario_nombres;
   ...
   //----- usuario_apellidos
   function NM_sub_cons_usuario_apellidos()
   {
         $this->usuario_apellidos = html_entity_decode($this->usuario_apellidos, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->usuario_apellidos = strip_tags($this->usuario_apellidos);
         if (!NM_is_utf8($this->usuario_apellidos))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->usuario_apellidos;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- usuario_cargo
   function NM_sub_cons_usuario_cargo()
   {
         $this->look_usuario_cargo = html_entity_decode($this->look_usuario_cargo, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_usuario_cargo = strip_tags($this->look_usuario_cargo);
         if (!NM_is_utf8($this->look_usuario_cargo))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_usuario_cargo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- usuario_dependencia
   function NM_sub_cons_usuario_dependencia()
   {
         $this->look_usuario_dependencia = html_entity_decode($this->look_usuario_dependencia, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_usuario_dependencia = strip_tags($this->look_usuario_dependencia);
         if (!NM_is_utf8($this->look_usuario_dependencia))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_usuario_dependencia;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- usuario_estado
   function NM_sub_cons_usuario_estado()
   {
         $this->usuario_estado = html_entity_decode($this->usuario_estado, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->usuario_estado = strip_tags($this->usuario_estado);
         if (!NM_is_utf8($this->usuario_estado))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->usuario_estado;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_idusuario()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->idusuario;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "###0";
         $this->Xls_col++;
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>FUNCIONARIOS :: Excel</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuario']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
