...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_vehiculos_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_vehiculos_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['recarga'];
}
?>
<body class="scFormPage" style="<?php echo $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_vehiculos']['error_buffer']) && '' != $_SESSION['scriptcase']['form_vehiculos']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_vehiculos']['error_buffer'];
}
...
<?php
 include_once("form_vehiculos_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_vehiculos_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_vehiculos_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_vehiculos_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_usuario_idusuario_line" id="hidden_field_data_usuario_idusuario" style="<?php echo $sStyleHidden_usuario_idusuario; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_usuario_idusuario_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_usuario_idusuario_label"><span id="id_label_usuario_idusuario"><?php echo $this->nm_new_label['usuario_idusuario']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_placa_line" id="hidden_field_data_vehiculo_placa" style="<?php echo $sStyleHidden_vehiculo_placa; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_placa_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_placa_label"><span id="id_label_vehiculo_placa"><?php echo $this->nm_new_label['vehiculo_placa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_placa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_placa'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_matricula_line" id="hidden_field_data_vehiculo_matricula" style="<?php echo $sStyleHidden_vehiculo_matricula; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_matricula_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_matricula_label"><span id="id_label_vehiculo_matricula"><?php echo $this->nm_new_label['vehiculo_matricula']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_matricula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_matricula'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_marca_line" id="hidden_field_data_vehiculo_marca" style="<?php echo $sStyleHidden_vehiculo_marca; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_marca_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_marca_label"><span id="id_label_vehiculo_marca"><?php echo $this->nm_new_label['vehiculo_marca']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_marca']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_marca'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_modelo_line" id="hidden_field_data_vehiculo_modelo" style="<?php echo $sStyleHidden_vehiculo_modelo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_modelo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_modelo_label"><span id="id_label_vehiculo_modelo"><?php echo $this->nm_new_label['vehiculo_modelo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_modelo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_modelo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_color_line" id="hidden_field_data_vehiculo_color" style="<?php echo $sStyleHidden_vehiculo_color; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_color_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_color_label"><span id="id_label_vehiculo_color"><?php echo $this->nm_new_label['vehiculo_color']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_color']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_color'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_chasis_line" id="hidden_field_data_vehiculo_chasis" style="<?php echo $sStyleHidden_vehiculo_chasis; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_chasis_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_chasis_label"><span id="id_label_vehiculo_chasis"><?php echo $this->nm_new_label['vehiculo_chasis']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_chasis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_chasis'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_numero_motor_line" id="hidden_field_data_vehiculo_numero_motor" style="<?php echo $sStyleHidden_vehiculo_numero_motor; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_numero_motor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_numero_motor_label"><span id="id_label_vehiculo_numero_motor"><?php echo $this->nm_new_label['vehiculo_numero_motor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_numero_motor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_numero_motor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_km_galon_line" id="hidden_field_data_vehiculo_km_galon" style="<?php echo $sStyleHidden_vehiculo_km_galon; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_km_galon_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_km_galon_label"><span id="id_label_vehiculo_km_galon"><?php echo $this->nm_new_label['vehiculo_km_galon']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_km_galon']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_km_galon'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_km_inicial_line" id="hidden_field_data_vehiculo_km_inicial" style="<?php echo $sStyleHidden_vehiculo_km_inicial; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_km_inicial_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_km_inicial_label"><span id="id_label_vehiculo_km_inicial"><?php echo $this->nm_new_label['vehiculo_km_inicial']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_km_inicial']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_km_inicial'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_tipo_combustible_line" id="hidden_field_data_vehiculo_tipo_combustible" style="<?php echo $sStyleHidden_vehiculo_tipo_combustible; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_tipo_combustible_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_tipo_combustible_label"><span id="id_label_vehiculo_tipo_combustible"><?php echo $this->nm_new_label['vehiculo_tipo_combustible']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_tipo_combustible']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_tipo_combustible'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['Lookup_vehiculo_tipo_combustible'][] = 'GASOLINA SUPER'; ?>
 <option  value="GASOLINA EXTRA" <?php  if ($this->vehiculo_tipo_combustible == "GASOLINA EXTRA") { echo " selected" ;} ?>>GASOLINA EXTRA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['Lookup_vehiculo_tipo_combustible'][] = 'GASOLINA EXTRA'; ?>
 <option  value="DIESEL" <?php  if ($this->vehiculo_tipo_combustible == "DIESEL") { echo " selected" ;} ?>>DIESEL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['Lookup_vehiculo_tipo_combustible'][] = 'DIESEL'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_estado_line" id="hidden_field_data_vehiculo_estado" style="<?php echo $sStyleHidden_vehiculo_estado; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_estado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_estado_label"><span id="id_label_vehiculo_estado"><?php echo $this->nm_new_label['vehiculo_estado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_estado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['php_cmp_required']['vehiculo_estado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['Lookup_vehiculo_estado'][] = 'ACTIVO'; ?>
 <option  value="INACTIVO" <?php  if ($this->vehiculo_estado == "INACTIVO") { echo " selected" ;} ?>>INACTIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['Lookup_vehiculo_estado'][] = 'INACTIVO'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_vehiculos_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_vehiculos_mob");
 parent.scAjaxDetailHeight("form_vehiculos_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
