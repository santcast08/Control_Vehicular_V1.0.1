...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Ingreso de datos del vehículo"); } else { echo strip_tags("Ingreso de datos del vehículo"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_vehiculos/form_vehiculos_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_vehiculos_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_vehiculos_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['recarga'];
}
?>
...
<?php
 include_once("form_vehiculos_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_vehiculos'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_vehiculos'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "Ingreso de datos del vehículo"; } else { echo "Ingreso de datos del vehículo"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   {
       $this->nm_new_label['usuario_idusuario'] = "Conductor";
   }
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['usuario_idusuario']) && $this->nmgp_cmp_readonly['usuario_idusuario'] == 'on')
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_usuario_idusuario_line" id="hidden_field_data_usuario_idusuario" style="<?php echo $sStyleHidden_usuario_idusuario; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_usuario_idusuario_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["usuario_idusuario"]) &&  $this->nmgp_cmp_readonly["usuario_idusuario"] == "on") { 
...
?>
<input type="hidden" name="usuario_idusuario" value="<?php echo $this->form_encode_input($usuario_idusuario) . "\">" . $usuario_idusuario_look . ""; ?>
<?php } else { ?>
<?php
...
<?php
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['vehiculo_placa']) && $this->nmgp_cmp_readonly['vehiculo_placa'] == 'on')
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_vehiculo_placa_label" id="hidden_field_label_vehiculo_placa" style="<?php echo $sStyleHidden_vehiculo_placa; ?>"><span id="id_label_vehiculo_placa"><?php echo $this->nm_new_label['vehiculo_placa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_placa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_placa'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_vehiculo_placa_line" id="hidden_field_data_vehiculo_placa" style="<?php echo $sStyleHidden_vehiculo_placa; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_placa_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["vehiculo_placa"]) &&  $this->nmgp_cmp_readonly["vehiculo_placa"] == "on") { 

 ?>
<input type="hidden" name="vehiculo_placa" value="<?php echo $this->form_encode_input($vehiculo_placa) . "\">" . $vehiculo_placa . ""; ?>
<?php } else { ?>
...
<?php
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['vehiculo_matricula']) && $this->nmgp_cmp_readonly['vehiculo_matricula'] == 'on')
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_vehiculo_matricula_label" id="hidden_field_label_vehiculo_matricula" style="<?php echo $sStyleHidden_vehiculo_matricula; ?>"><span id="id_label_vehiculo_matricula"><?php echo $this->nm_new_label['vehiculo_matricula']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_matricula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_matricula'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_vehiculo_matricula_line" id="hidden_field_data_vehiculo_matricula" style="<?php echo $sStyleHidden_vehiculo_matricula; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_matricula_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["vehiculo_matricula"]) &&  $this->nmgp_cmp_readonly["vehiculo_matricula"] == "on") { 

 ?>
<input type="hidden" name="vehiculo_matricula" value="<?php echo $this->form_encode_input($vehiculo_matricula) . "\">" . $vehiculo_matricula . ""; ?>
<?php } else { ?>
...
<?php
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['vehiculo_marca']) && $this->nmgp_cmp_readonly['vehiculo_marca'] == 'on')
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_vehiculo_marca_label" id="hidden_field_label_vehiculo_marca" style="<?php echo $sStyleHidden_vehiculo_marca; ?>"><span id="id_label_vehiculo_marca"><?php echo $this->nm_new_label['vehiculo_marca']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_marca']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_marca'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_vehiculo_marca_line" id="hidden_field_data_vehiculo_marca" style="<?php echo $sStyleHidden_vehiculo_marca; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_marca_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["vehiculo_marca"]) &&  $this->nmgp_cmp_readonly["vehiculo_marca"] == "on") { 

 ?>
<input type="hidden" name="vehiculo_marca" value="<?php echo $this->form_encode_input($vehiculo_marca) . "\">" . $vehiculo_marca . ""; ?>
<?php } else { ?>
...
<?php
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['vehiculo_modelo']) && $this->nmgp_cmp_readonly['vehiculo_modelo'] == 'on')
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_vehiculo_modelo_label" id="hidden_field_label_vehiculo_modelo" style="<?php echo $sStyleHidden_vehiculo_modelo; ?>"><span id="id_label_vehiculo_modelo"><?php echo $this->nm_new_label['vehiculo_modelo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_modelo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_modelo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_vehiculo_modelo_line" id="hidden_field_data_vehiculo_modelo" style="<?php echo $sStyleHidden_vehiculo_modelo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_modelo_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["vehiculo_modelo"]) &&  $this->nmgp_cmp_readonly["vehiculo_modelo"] == "on") { 

 ?>
<input type="hidden" name="vehiculo_modelo" value="<?php echo $this->form_encode_input($vehiculo_modelo) . "\">" . $vehiculo_modelo . ""; ?>
<?php } else { ?>
...
<?php
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['vehiculo_color']) && $this->nmgp_cmp_readonly['vehiculo_color'] == 'on')
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_vehiculo_color_label" id="hidden_field_label_vehiculo_color" style="<?php echo $sStyleHidden_vehiculo_color; ?>"><span id="id_label_vehiculo_color"><?php echo $this->nm_new_label['vehiculo_color']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_color']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_color'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_vehiculo_color_line" id="hidden_field_data_vehiculo_color" style="<?php echo $sStyleHidden_vehiculo_color; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_color_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["vehiculo_color"]) &&  $this->nmgp_cmp_readonly["vehiculo_color"] == "on") { 

 ?>
<input type="hidden" name="vehiculo_color" value="<?php echo $this->form_encode_input($vehiculo_color) . "\">" . $vehiculo_color . ""; ?>
<?php } else { ?>
<span id="id_read_on_vehiculo_color" class="sc-ui-readonly-vehiculo_color css_vehiculo_color_line" style="<?php echo $sStyleReadLab_vehiculo_color; ?>"><?php echo $this->form_encode_input($this->vehiculo_color); ?></span><span id="id_read_off_vehiculo_color" style="white-space: nowrap;<?php echo $sStyleReadInp_vehiculo_color; ?>">
 ...
 size=12 maxlength=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '<?php echo $this->allowedCharsCharset("abcdefghijklmnopqrstuvwxyz0123456789áéíóúàèìòùãõâêîôûäëïöüñýÿ¨´`^~ç .,") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['vehiculo_chasis']) && $this->nmgp_cmp_readonly['vehiculo_chasis'] == 'on')
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_vehiculo_chasis_label" id="hidden_field_label_vehiculo_chasis" style="<?php echo $sStyleHidden_vehiculo_chasis; ?>"><span id="id_label_vehiculo_chasis"><?php echo $this->nm_new_label['vehiculo_chasis']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_chasis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_chasis'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_vehiculo_chasis_line" id="hidden_field_data_vehiculo_chasis" style="<?php echo $sStyleHidden_vehiculo_chasis; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_chasis_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["vehiculo_chasis"]) &&  $this->nmgp_cmp_readonly["vehiculo_chasis"] == "on") { 

 ?>
<input type="hidden" name="vehiculo_chasis" value="<?php echo $this->form_encode_input($vehiculo_chasis) . "\">" . $vehiculo_chasis . ""; ?>
<?php } else { ?>
...
<?php
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['vehiculo_numero_motor']) && $this->nmgp_cmp_readonly['vehiculo_numero_motor'] == 'on')
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_vehiculo_numero_motor_label" id="hidden_field_label_vehiculo_numero_motor" style="<?php echo $sStyleHidden_vehiculo_numero_motor; ?>"><span id="id_label_vehiculo_numero_motor"><?php echo $this->nm_new_label['vehiculo_numero_motor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_numero_motor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_numero_motor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_vehiculo_numero_motor_line" id="hidden_field_data_vehiculo_numero_motor" style="<?php echo $sStyleHidden_vehiculo_numero_motor; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_numero_motor_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["vehiculo_numero_motor"]) &&  $this->nmgp_cmp_readonly["vehiculo_numero_motor"] == "on") { 

 ?>
<input type="hidden" name="vehiculo_numero_motor" value="<?php echo $this->form_encode_input($vehiculo_numero_motor) . "\">" . $vehiculo_numero_motor . ""; ?>
<?php } else { ?>
...
<?php
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['vehiculo_km_galon']) && $this->nmgp_cmp_readonly['vehiculo_km_galon'] == 'on')
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_vehiculo_km_galon_label" id="hidden_field_label_vehiculo_km_galon" style="<?php echo $sStyleHidden_vehiculo_km_galon; ?>"><span id="id_label_vehiculo_km_galon"><?php echo $this->nm_new_label['vehiculo_km_galon']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_km_galon']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_km_galon'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_vehiculo_km_galon_line" id="hidden_field_data_vehiculo_km_galon" style="<?php echo $sStyleHidden_vehiculo_km_galon; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_km_galon_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["vehiculo_km_galon"]) &&  $this->nmgp_cmp_readonly["vehiculo_km_galon"] == "on") { 

 ?>
<input type="hidden" name="vehiculo_km_galon" value="<?php echo $this->form_encode_input($vehiculo_km_galon) . "\">" . $vehiculo_km_galon . ""; ?>
<?php } else { ?>
<span id="id_read_on_vehiculo_km_galon" class="sc-ui-readonly-vehiculo_km_galon css_vehiculo_km_galon_line" style="<?php echo $sStyleReadLab_vehiculo_km_galon; ?>"><?php echo $this->form_encode_input($this->vehiculo_km_galon); ?></span><span id="id_read_off_vehiculo_km_galon" style="white-space: nowrap;<?php echo $sStyleReadInp_vehiculo_km_galon; ?>">
 ...
 size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '', thousandsFormat: <?php echo $this->field_config['vehiculo_km_galon']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['vehiculo_km_galon']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
   ...
   <?php
    ...
    {
        $this->nm_new_label['vehiculo_km_inicial'] = "Kilometraje Inicial";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['vehiculo_km_inicial']) && $this->nmgp_cmp_readonly['vehiculo_km_inicial'] == 'on')
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_vehiculo_km_inicial_label" id="hidden_field_label_vehiculo_km_inicial" style="<?php echo $sStyleHidden_vehiculo_km_inicial; ?>"><span id="id_label_vehiculo_km_inicial"><?php echo $this->nm_new_label['vehiculo_km_inicial']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_km_inicial']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_km_inicial'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_vehiculo_km_inicial_line" id="hidden_field_data_vehiculo_km_inicial" style="<?php echo $sStyleHidden_vehiculo_km_inicial; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_km_inicial_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["vehiculo_km_inicial"]) &&  $this->nmgp_cmp_readonly["vehiculo_km_inicial"] == "on") { 

 ?>
<input type="hidden" name="vehiculo_km_inicial" value="<?php echo $this->form_encode_input($vehiculo_km_inicial) . "\">" . $vehiculo_km_inicial . ""; ?>
<?php } else { ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   {
       $this->nm_new_label['vehiculo_tipo_combustible'] = "Tipo Combustible";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['vehiculo_tipo_combustible']) && $this->nmgp_cmp_readonly['vehiculo_tipo_combustible'] == 'on')
   {
       $bTestReadOnly = false;
...
<input type=hidden name="vehiculo_tipo_combustible" value="<?php echo $this->form_encode_input($this->vehiculo_tipo_combustible) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_vehiculo_tipo_combustible_label" id="hidden_field_label_vehiculo_tipo_combustible" style="<?php echo $sStyleHidden_vehiculo_tipo_combustible; ?>"><span id="id_label_vehiculo_tipo_combustible"><?php echo $this->nm_new_label['vehiculo_tipo_combustible']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_tipo_combustible']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_tipo_combustible'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_vehiculo_tipo_combustible_line" id="hidden_field_data_vehiculo_tipo_combustible" style="<?php echo $sStyleHidden_vehiculo_tipo_combustible; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_tipo_combustible_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["vehiculo_tipo_combustible"]) &&  $this->nmgp_cmp_readonly["vehiculo_tipo_combustible"] == "on") { 

$vehiculo_tipo_combustible_look = "";
 if ($this->vehiculo_tipo_combustible == "GASOLINA SUPER") { $vehiculo_tipo_combustible_look .= "GASOLINA SUPER" ;} 
 if ($this->vehiculo_tipo_combustible == "GASOLINA EXTRA") { $vehiculo_tipo_combustible_look .= "GASOLINA EXTRA" ;} 
 if ($this->vehiculo_tipo_combustible == "DIESEL") { $vehiculo_tipo_combustible_look .= "DIESEL" ;} 
 if (empty($vehiculo_tipo_combustible_look)) { $vehiculo_tipo_combustible_look = $this->vehiculo_tipo_combustible; }
?>
<input type="hidden" name="vehiculo_tipo_combustible" value="<?php echo $this->form_encode_input($vehiculo_tipo_combustible) . "\">" . $vehiculo_tipo_combustible_look . ""; ?>
<?php } else { ?>
<?php
...
$vehiculo_tipo_combustible_look = "";
 ...
 if (empty($vehiculo_tipo_combustible_look)) { $vehiculo_tipo_combustible_look = $this->vehiculo_tipo_combustible; }
?>
<span id="id_read_on_vehiculo_tipo_combustible" class="css_vehiculo_tipo_combustible_line"  style="<?php echo $sStyleReadLab_vehiculo_tipo_combustible; ?>"><?php echo $this->form_encode_input($vehiculo_tipo_combustible_look); ?></span><span id="id_read_off_vehiculo_tipo_combustible" style="<?php echo $sStyleReadInp_vehiculo_tipo_combustible; ?>">
 <span id="idAjaxSelect_vehiculo_tipo_combustible"><select class="sc-js-input scFormObjectOdd css_vehiculo_tipo_combustible_obj" style="" id="id_sc_field_vehiculo_tipo_combustible" name="vehiculo_tipo_combustible" size="1" alt="{type: 'select', enterTab: false}">
 <option  value="GASOLINA SUPER" <?php  if ($this->vehiculo_tipo_combustible == "GASOLINA SUPER") { echo " selected" ;} ?>>GASOLINA SUPER</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['Lookup_vehiculo_tipo_combustible'][] = 'GASOLINA SUPER'; ?>
 <option  value="GASOLINA EXTRA" <?php  if ($this->vehiculo_tipo_combustible == "GASOLINA EXTRA") { echo " selected" ;} ?>>GASOLINA EXTRA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['Lookup_vehiculo_tipo_combustible'][] = 'GASOLINA EXTRA'; ?>
 <option  value="DIESEL" <?php  if ($this->vehiculo_tipo_combustible == "DIESEL") { echo " selected" ;} ?>>DIESEL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['Lookup_vehiculo_tipo_combustible'][] = 'DIESEL'; ?>
 </select></span>
</span><?php  }?>
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['vehiculo_estado']) && $this->nmgp_cmp_readonly['vehiculo_estado'] == 'on')
   {
       $bTestReadOnly = false;
...
<input type=hidden name="vehiculo_estado" value="<?php echo $this->form_encode_input($this->vehiculo_estado) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_vehiculo_estado_label" id="hidden_field_label_vehiculo_estado" style="<?php echo $sStyleHidden_vehiculo_estado; ?>"><span id="id_label_vehiculo_estado"><?php echo $this->nm_new_label['vehiculo_estado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_estado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['vehiculo_estado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_vehiculo_estado_line" id="hidden_field_data_vehiculo_estado" style="<?php echo $sStyleHidden_vehiculo_estado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_estado_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["vehiculo_estado"]) &&  $this->nmgp_cmp_readonly["vehiculo_estado"] == "on") { 

$vehiculo_estado_look = "";
 if ($this->vehiculo_estado == "ACTIVO") { $vehiculo_estado_look .= "ACTIVO" ;} 
 if ($this->vehiculo_estado == "INACTIVO") { $vehiculo_estado_look .= "INACTIVO" ;} 
 if (empty($vehiculo_estado_look)) { $vehiculo_estado_look = $this->vehiculo_estado; }
?>
<input type="hidden" name="vehiculo_estado" value="<?php echo $this->form_encode_input($vehiculo_estado) . "\">" . $vehiculo_estado_look . ""; ?>
<?php } else { ?>
<?php
...
$vehiculo_estado_look = "";
 ...
 if (empty($vehiculo_estado_look)) { $vehiculo_estado_look = $this->vehiculo_estado; }
?>
<span id="id_read_on_vehiculo_estado" class="css_vehiculo_estado_line"  style="<?php echo $sStyleReadLab_vehiculo_estado; ?>"><?php echo $this->form_encode_input($vehiculo_estado_look); ?></span><span id="id_read_off_vehiculo_estado" style="<?php echo $sStyleReadInp_vehiculo_estado; ?>">
 <span id="idAjaxSelect_vehiculo_estado"><select class="sc-js-input scFormObjectOdd css_vehiculo_estado_obj" style="" id="id_sc_field_vehiculo_estado" name="vehiculo_estado" size="1" alt="{type: 'select', enterTab: false}">
 <option  value="ACTIVO" <?php  if ($this->vehiculo_estado == "ACTIVO") { echo " selected" ;} ?><?php  if (empty($this->vehiculo_estado)) { echo " selected" ;} ?>>ACTIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['Lookup_vehiculo_estado'][] = 'ACTIVO'; ?>
 <option  value="INACTIVO" <?php  if ($this->vehiculo_estado == "INACTIVO") { echo " selected" ;} ?>>INACTIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['Lookup_vehiculo_estado'][] = 'INACTIVO'; ?>
 </select></span>
</span><?php  }?>
...
<?php
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['vehiculo_fechaasignacion']) && $this->nmgp_cmp_readonly['vehiculo_fechaasignacion'] == 'on')
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_fechaasignacion_line" id="hidden_field_data_vehiculo_fechaasignacion" style="<?php echo $sStyleHidden_vehiculo_fechaasignacion; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_fechaasignacion_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["vehiculo_fechaasignacion"]) &&  $this->nmgp_cmp_readonly["vehiculo_fechaasignacion"] == "on") { 

 ?>
<input type="hidden" name="vehiculo_fechaasignacion" value="<?php echo $this->form_encode_input($vehiculo_fechaasignacion) . "\">" . $vehiculo_fechaasignacion . ""; ?>
<?php } else { ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_vehiculos");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_vehiculos");
 parent.scAjaxDetailHeight("form_vehiculos", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
