...
class grid_tipo_mantenimiento_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_tipo_mantenimiento.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['rtf_name']);
      }
   ...
   function NM_export_tipo_mantenimiento_descripcion()
   {
         ...
         $this->tipo_mantenimiento_descripcion = str_replace('<', '&lt;', $this->tipo_mantenimiento_descripcion);
         $this->tipo_mantenimiento_descripcion = str_replace('>', '&gt;', $this->tipo_mantenimiento_descripcion);
         $this->Texto_tag .= "<td>" . $this->tipo_mantenimiento_descripcion . "</td>\r\n";
   }
   ...
   function NM_export_tipo_mantenimiento_estado()
   {
         ...
         $this->tipo_mantenimiento_estado = str_replace('<', '&lt;', $this->tipo_mantenimiento_estado);
         $this->tipo_mantenimiento_estado = str_replace('>', '&gt;', $this->tipo_mantenimiento_estado);
         $this->Texto_tag .= "<td>" . $this->tipo_mantenimiento_estado . "</td>\r\n";
   }
   ...
   function NM_export_idtipo_mantenimiento()
   {
         ...
         $this->idtipo_mantenimiento = str_replace('<', '&lt;', $this->idtipo_mantenimiento);
         $this->idtipo_mantenimiento = str_replace('>', '&gt;', $this->idtipo_mantenimiento);
         $this->Texto_tag .= "<td>" . $this->idtipo_mantenimiento . "</td>\r\n";
   }
   ...
   function NM_export_vehiculos_idvehiculo()
   {
         ...
         $this->vehiculos_idvehiculo = str_replace('<', '&lt;', $this->vehiculos_idvehiculo);
         $this->vehiculos_idvehiculo = str_replace('>', '&gt;', $this->vehiculos_idvehiculo);
         $this->Texto_tag .= "<td>" . $this->vehiculos_idvehiculo . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>TIPOS DE MANTENIMIENTO :: RTF</TITLE>
