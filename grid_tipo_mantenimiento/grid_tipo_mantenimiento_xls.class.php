...
class grid_tipo_mantenimiento_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_tipo_mantenimiento" . $this->Xls_tp;
          $this->Tit_doc    = "grid_tipo_mantenimiento" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      { 
          ...
          if ($Cada_col == "tipo_mantenimiento_descripcion" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              if (!NM_is_utf8($SC_Label))
          ...
          if ($Cada_col == "tipo_mantenimiento_estado" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              if (!NM_is_utf8($SC_Label))
          ...
          if ($Cada_col == "idtipo_mantenimiento" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              if (!NM_is_utf8($SC_Label))
          ...
          if ($Cada_col == "vehiculos_idvehiculo" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              if (!NM_is_utf8($SC_Label))
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['embutida_label'])
      { 
      ...
      while (!$rs->EOF)
      {
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['embutida'])
         { 
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['embutida'])
      { 
   ...
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         $this->tipo_mantenimiento_descripcion = html_entity_decode($this->tipo_mantenimiento_descripcion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tipo_mantenimiento_descripcion = strip_tags($this->tipo_mantenimiento_descripcion);
         if (!NM_is_utf8($this->tipo_mantenimiento_descripcion))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tipo_mantenimiento_descripcion, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   ...
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         $this->tipo_mantenimiento_estado = html_entity_decode($this->tipo_mantenimiento_estado, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tipo_mantenimiento_estado = strip_tags($this->tipo_mantenimiento_estado);
         if (!NM_is_utf8($this->tipo_mantenimiento_estado))
         {
             $this->tipo_mantenimiento_estado = sc_convert_encoding($this->tipo_mantenimiento_estado, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tipo_mantenimiento_estado, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   ...
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!NM_is_utf8($this->vehiculos_idvehiculo))
         {
             $this->vehiculos_idvehiculo = sc_convert_encoding($this->vehiculos_idvehiculo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->vehiculos_idvehiculo))
         {
             $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getNumberFormat()->setFormatCode('###0');
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->vehiculos_idvehiculo);
         $this->Xls_col++;
   }
   //----- tipo
   ...
   //----- tipo_mantenimiento_descripcion
   function NM_sub_cons_tipo_mantenimiento_descripcion()
   {
         $this->tipo_mantenimiento_descripcion = html_entity_decode($this->tipo_mantenimiento_descripcion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tipo_mantenimiento_descripcion = strip_tags($this->tipo_mantenimiento_descripcion);
         if (!NM_is_utf8($this->tipo_mantenimiento_descripcion))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tipo_mantenimiento_descripcion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- tipo_mantenimiento_estado
   function NM_sub_cons_tipo_mantenimiento_estado()
   {
         $this->tipo_mantenimiento_estado = html_entity_decode($this->tipo_mantenimiento_estado, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tipo_mantenimiento_estado = strip_tags($this->tipo_mantenimiento_estado);
         if (!NM_is_utf8($this->tipo_mantenimiento_estado))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tipo_mantenimiento_estado;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- idtipo_mantenimiento
   function NM_sub_cons_idtipo_mantenimiento()
   {
         if (!NM_is_utf8($this->idtipo_mantenimiento))
         {
             $this->idtipo_mantenimiento = sc_convert_encoding($this->idtipo_mantenimiento, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->idtipo_mantenimiento;
   ...
   //----- vehiculos_idvehiculo
   function NM_sub_cons_vehiculos_idvehiculo()
   {
         if (!NM_is_utf8($this->vehiculos_idvehiculo))
         {
             $this->vehiculos_idvehiculo = sc_convert_encoding($this->vehiculos_idvehiculo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->vehiculos_idvehiculo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "###0";
         $this->Xls_col++;
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>TIPOS DE MANTENIMIENTO :: Excel</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_mantenimiento']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
