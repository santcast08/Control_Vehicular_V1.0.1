...
$oExportPdf = new grid_tipo_mantenimiento_export_pdf;
$oExportPdf->exportPdf();

class grid_tipo_mantenimiento_export_pdf {
...
$STR_btn    = '';
$STR_lang   = '';
if (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_tipo_mantenimiento']['grid_tipo_mantenimiento_iframe_params']))
{
    $STR_schema = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_tipo_mantenimiento']['grid_tipo_mantenimiento_iframe_params']['str_schema'];
    $STR_tmp    = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_tipo_mantenimiento']['grid_tipo_mantenimiento_iframe_params']['str_tmp'];
    $STR_prod   = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_tipo_mantenimiento']['grid_tipo_mantenimiento_iframe_params']['str_prod'];
    $STR_btn    = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_tipo_mantenimiento']['grid_tipo_mantenimiento_iframe_params']['str_btn'];
    $STR_lang   = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_tipo_mantenimiento']['grid_tipo_mantenimiento_iframe_params']['str_lang'];
}
if (isset($aParams['sc_create_charts'])) {
    $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_tipo_mantenimiento']['skip_charts'] = 'N' == $aParams['sc_create_charts'];
}
if (isset($aParams['chart_level'])) {
    $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_tipo_mantenimiento']['chart_level'] = $aParams['chart_level'];
}
elseif (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_tipo_mantenimiento']['chart_level'])) {
    unset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_tipo_mantenimiento']['chart_level']);
}
if (isset($aParams['page_break_pdf']) && $aParams['page_break_pdf'] != "_NO_")
{
    $Arr_page_pdf = explode("_BRK_", $aParams['page_break_pdf']);
    foreach ($_SESSION['sc_session'][$aParams['script_case_init']]['grid_tipo_mantenimiento']['Page_break_PDF'] as $cmp => $opt)
    {
        if (in_array($cmp, $Arr_page_pdf))
        {
            $_SESSION['sc_session'][$aParams['script_case_init']]['grid_tipo_mantenimiento']['Page_break_PDF'][$cmp] = "S";
        }
        else
        {
            $_SESSION['sc_session'][$aParams['script_case_init']]['grid_tipo_mantenimiento']['Page_break_PDF'][$cmp] = "N";
        }
    }
}
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_tipo_mantenimiento']['opc_pdf']['all_cab']     = (isset($aParams['pdf_all_cab']))     ? $aParams['pdf_all_cab']     : "N";
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_tipo_mantenimiento']['opc_pdf']['all_label']   = (isset($aParams['pdf_all_label']))   ? $aParams['pdf_all_label']   : "N";
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_tipo_mantenimiento']['opc_pdf']['label_group'] = (isset($aParams['pdf_label_group'])) ? $aParams['pdf_label_group'] : "N";
$Nm_lang     = array();
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_tipo_mantenimiento_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_tipo_mantenimiento']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_tipo_mantenimiento']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_tipo_mantenimiento.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_tipo_mantenimiento']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_tipo_mantenimiento']['pdf_name'] : "grid_tipo_mantenimiento.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$path_doc_md5 = md5($NM_pdfurl . "/" . $NM_pdfbase);
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_tipo_mantenimiento'][$path_doc_md5][0] = $NM_pdfurl . "/" . $NM_pdfbase;
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_tipo_mantenimiento'][$path_doc_md5][1] = $NM_tit_doc;
$NM_volta   = "volta_grid";
?>
