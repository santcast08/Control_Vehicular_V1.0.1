  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipo_mantenimiento" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idtipo_mantenimiento
  function do_ajax_form_tipo_mantenimiento_validate_idtipo_mantenimiento()
  {
    var nomeCampo_idtipo_mantenimiento = "idtipo_mantenimiento";
    var var_idtipo_mantenimiento = scAjaxGetFieldHidden(nomeCampo_idtipo_mantenimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_mantenimiento_validate_idtipo_mantenimiento(var_idtipo_mantenimiento, var_script_case_init, do_ajax_form_tipo_mantenimiento_validate_idtipo_mantenimiento_cb);
  } // do_ajax_form_tipo_mantenimiento_validate_idtipo_mantenimiento

  function do_ajax_form_tipo_mantenimiento_validate_idtipo_mantenimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idtipo_mantenimiento";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_mantenimiento_validate_idtipo_mantenimiento_cb

  // ---------- Validate tipo
  function do_ajax_form_tipo_mantenimiento_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldRadio(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_mantenimiento_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_tipo_mantenimiento_validate_tipo_cb);
  } // do_ajax_form_tipo_mantenimiento_validate_tipo

  function do_ajax_form_tipo_mantenimiento_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_mantenimiento_validate_tipo_cb

  // ---------- Validate tipo_mantenimiento_descripcion
  function do_ajax_form_tipo_mantenimiento_validate_tipo_mantenimiento_descripcion()
  {
    var nomeCampo_tipo_mantenimiento_descripcion = "tipo_mantenimiento_descripcion";
    var var_tipo_mantenimiento_descripcion = scAjaxGetFieldText(nomeCampo_tipo_mantenimiento_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_mantenimiento_validate_tipo_mantenimiento_descripcion(var_tipo_mantenimiento_descripcion, var_script_case_init, do_ajax_form_tipo_mantenimiento_validate_tipo_mantenimiento_descripcion_cb);
  } // do_ajax_form_tipo_mantenimiento_validate_tipo_mantenimiento_descripcion

  function do_ajax_form_tipo_mantenimiento_validate_tipo_mantenimiento_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_mantenimiento_descripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_mantenimiento_validate_tipo_mantenimiento_descripcion_cb

  // ---------- Validate tipo_mantenimiento_estado
  function do_ajax_form_tipo_mantenimiento_validate_tipo_mantenimiento_estado()
  {
    var nomeCampo_tipo_mantenimiento_estado = "tipo_mantenimiento_estado";
    var var_tipo_mantenimiento_estado = scAjaxGetFieldSelect(nomeCampo_tipo_mantenimiento_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_mantenimiento_validate_tipo_mantenimiento_estado(var_tipo_mantenimiento_estado, var_script_case_init, do_ajax_form_tipo_mantenimiento_validate_tipo_mantenimiento_estado_cb);
  } // do_ajax_form_tipo_mantenimiento_validate_tipo_mantenimiento_estado

  function do_ajax_form_tipo_mantenimiento_validate_tipo_mantenimiento_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_mantenimiento_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_mantenimiento_validate_tipo_mantenimiento_estado_cb

  // ---------- Validate vehiculos_idvehiculo
  function do_ajax_form_tipo_mantenimiento_validate_vehiculos_idvehiculo()
  {
    var nomeCampo_vehiculos_idvehiculo = "vehiculos_idvehiculo";
    var var_vehiculos_idvehiculo = scAjaxGetFieldSelect(nomeCampo_vehiculos_idvehiculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_mantenimiento_validate_vehiculos_idvehiculo(var_vehiculos_idvehiculo, var_script_case_init, do_ajax_form_tipo_mantenimiento_validate_vehiculos_idvehiculo_cb);
  } // do_ajax_form_tipo_mantenimiento_validate_vehiculos_idvehiculo

  function do_ajax_form_tipo_mantenimiento_validate_vehiculos_idvehiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vehiculos_idvehiculo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_mantenimiento_validate_vehiculos_idvehiculo_cb
  // ---------- Form
  function do_ajax_form_tipo_mantenimiento_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tipo_mantenimiento_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idtipo_mantenimiento = scAjaxGetFieldHidden("idtipo_mantenimiento");
    var var_tipo = scAjaxGetFieldRadio("tipo");
    var var_tipo_mantenimiento_descripcion = scAjaxGetFieldText("tipo_mantenimiento_descripcion");
    var var_tipo_mantenimiento_estado = scAjaxGetFieldSelect("tipo_mantenimiento_estado");
    var var_vehiculos_idvehiculo = scAjaxGetFieldSelect("vehiculos_idvehiculo");
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_mantenimiento_submit_form(var_idtipo_mantenimiento, var_tipo, var_tipo_mantenimiento_descripcion, var_tipo_mantenimiento_estado, var_vehiculos_idvehiculo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipo_mantenimiento_submit_form_cb);
  } // do_ajax_form_tipo_mantenimiento_submit_form

  function do_ajax_form_tipo_mantenimiento_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idtipo_mantenimiento");
      scAjaxHideErrorDisplay("tipo");
      scAjaxHideErrorDisplay("tipo_mantenimiento_descripcion");
      scAjaxHideErrorDisplay("tipo_mantenimiento_estado");
      scAjaxHideErrorDisplay("vehiculos_idvehiculo");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_tipo_mantenimiento_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tipo_mantenimiento_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tipo_mantenimiento_estado");
    scAjaxHideErrorDisplay("vehiculos_idvehiculo");
    var var_idtipo_mantenimiento = document.F2.idtipo_mantenimiento.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_mantenimiento_navigate_form(var_idtipo_mantenimiento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipo_mantenimiento_navigate_form_cb);
  } // do_ajax_form_tipo_mantenimiento_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_mantenimiento']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipo_mantenimiento_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tipo_mantenimiento_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idtipo_mantenimiento.value = scAjaxGetKeyValue("idtipo_mantenimiento");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_tipo_mantenimiento_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tipo_mantenimiento_navigate_form_cb
  function sc_hide_form_tipo_mantenimiento_form()
  {
  ...
  ajax_field_list[0] = "idtipo_mantenimiento";
  ajax_field_list[1] = "tipo";
  ajax_field_list[2] = "tipo_mantenimiento_descripcion";
  ajax_field_list[3] = "tipo_mantenimiento_estado";
  ajax_field_list[4] = "vehiculos_idvehiculo";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idtipo_mantenimiento": {"label": "Id Tipo Mantenimiento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo": {"label": "Tipo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_mantenimiento_descripcion": {"label": "Tipo Mantenimiento Descripcion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_mantenimiento_estado": {"label": "Estado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vehiculos_idvehiculo": {"label": "Vehiculos Id Vehiculo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idtipo_mantenimiento": new Array(),
    "tipo": new Array(),
    "tipo_mantenimiento_descripcion": new Array(),
    "tipo_mantenimiento_estado": new Array(),
    "vehiculos_idvehiculo": new Array()
  };
  ajax_field_mult["idtipo_mantenimiento"][1] = "idtipo_mantenimiento";
  ajax_field_mult["tipo"][1] = "tipo";
  ajax_field_mult["tipo_mantenimiento_descripcion"][1] = "tipo_mantenimiento_descripcion";
  ajax_field_mult["tipo_mantenimiento_estado"][1] = "tipo_mantenimiento_estado";
  ajax_field_mult["vehiculos_idvehiculo"][1] = "vehiculos_idvehiculo";

  var ajax_field_id = {
    "tipo": new Array("hidden_field_label_tipo", "hidden_field_data_tipo"),
    "tipo_mantenimiento_descripcion": new Array("hidden_field_label_tipo_mantenimiento_descripcion", "hidden_field_data_tipo_mantenimiento_descripcion"),
    "tipo_mantenimiento_estado": new Array("hidden_field_label_tipo_mantenimiento_estado", "hidden_field_data_tipo_mantenimiento_estado")
  };

  var ajax_read_only = {
    "idtipo_mantenimiento": "on",
    "tipo": "off",
    "tipo_mantenimiento_descripcion": "off",
    "tipo_mantenimiento_estado": "off",
    "vehiculos_idvehiculo": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idtipo_mantenimiento" == sIndex)
    {
    ...
    if ("tipo_mantenimiento_descripcion" == sIndex)
    {
    ...
    if ("tipo_mantenimiento_estado" == sIndex)
    {
    ...
    if ("vehiculos_idvehiculo" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
