  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipo_mantenimiento_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tipo_mantenimiento_mob_validate_idtipo_mantenimiento()
  {
    ...
    x_ajax_form_tipo_mantenimiento_mob_validate_idtipo_mantenimiento(var_idtipo_mantenimiento, var_script_case_init, do_ajax_form_tipo_mantenimiento_mob_validate_idtipo_mantenimiento_cb);
  } // do_ajax_form_tipo_mantenimiento_mob_validate_idtipo_mantenimiento

  function do_ajax_form_tipo_mantenimiento_mob_validate_idtipo_mantenimiento_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_mantenimiento_mob_validate_idtipo_mantenimiento_cb

  // ---------- Validate tipo
  function do_ajax_form_tipo_mantenimiento_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldRadio(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_mantenimiento_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_tipo_mantenimiento_mob_validate_tipo_cb);
  } // do_ajax_form_tipo_mantenimiento_mob_validate_tipo

  function do_ajax_form_tipo_mantenimiento_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_mantenimiento_mob_validate_tipo_cb

  // ---------- Validate tipo_mantenimiento_descripcion
  function do_ajax_form_tipo_mantenimiento_mob_validate_tipo_mantenimiento_descripcion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_mantenimiento_mob_validate_tipo_mantenimiento_descripcion(var_tipo_mantenimiento_descripcion, var_script_case_init, do_ajax_form_tipo_mantenimiento_mob_validate_tipo_mantenimiento_descripcion_cb);
  } // do_ajax_form_tipo_mantenimiento_mob_validate_tipo_mantenimiento_descripcion

  function do_ajax_form_tipo_mantenimiento_mob_validate_tipo_mantenimiento_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_mantenimiento_mob_validate_tipo_mantenimiento_descripcion_cb

  // ---------- Validate tipo_mantenimiento_estado
  function do_ajax_form_tipo_mantenimiento_mob_validate_tipo_mantenimiento_estado()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_mantenimiento_mob_validate_tipo_mantenimiento_estado(var_tipo_mantenimiento_estado, var_script_case_init, do_ajax_form_tipo_mantenimiento_mob_validate_tipo_mantenimiento_estado_cb);
  } // do_ajax_form_tipo_mantenimiento_mob_validate_tipo_mantenimiento_estado

  function do_ajax_form_tipo_mantenimiento_mob_validate_tipo_mantenimiento_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_mantenimiento_mob_validate_tipo_mantenimiento_estado_cb

  // ---------- Validate vehiculos_idvehiculo
  function do_ajax_form_tipo_mantenimiento_mob_validate_vehiculos_idvehiculo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_mantenimiento_mob_validate_vehiculos_idvehiculo(var_vehiculos_idvehiculo, var_script_case_init, do_ajax_form_tipo_mantenimiento_mob_validate_vehiculos_idvehiculo_cb);
  } // do_ajax_form_tipo_mantenimiento_mob_validate_vehiculos_idvehiculo

  function do_ajax_form_tipo_mantenimiento_mob_validate_vehiculos_idvehiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_mantenimiento_mob_validate_vehiculos_idvehiculo_cb
  // ---------- Form
  function do_ajax_form_tipo_mantenimiento_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tipo_mantenimiento_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_mantenimiento_mob_submit_form(var_idtipo_mantenimiento, var_tipo, var_tipo_mantenimiento_descripcion, var_tipo_mantenimiento_estado, var_vehiculos_idvehiculo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipo_mantenimiento_mob_submit_form_cb);
  } // do_ajax_form_tipo_mantenimiento_mob_submit_form

  function do_ajax_form_tipo_mantenimiento_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_tipo_mantenimiento_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tipo_mantenimiento_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_mantenimiento_mob_navigate_form(var_idtipo_mantenimiento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipo_mantenimiento_mob_navigate_form_cb);
  } // do_ajax_form_tipo_mantenimiento_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_mantenimiento_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipo_mantenimiento_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tipo_mantenimiento_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
...
{
?>
    do_ajax_form_tipo_mantenimiento_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tipo_mantenimiento_mob_navigate_form_cb
  function sc_hide_form_tipo_mantenimiento_mob_form()
  {
