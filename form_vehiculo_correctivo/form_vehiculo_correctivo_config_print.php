 ...
 */
    ...
    session_start();
    $SC_apl_proc = "form_vehiculo_correctivo";
/* sc_apl_default */
  ...
  <div id="tabs">
    ...
    <div id="tabs-general" style="padding: 0px; margin: 0px">
      ...
      <table class="scGridBorder" width='100%' cellspacing="0" cellpadding="0">
          ...
          {
             $sDisplay = ($opc == "PC" || $res_cons != "s" || $origem == "chart") ? ' style="display: none"' : '';
          ?>
          ...
          <?php
            $sDisplay = ($opc == "RC" || $res_cons != "s" || $origem != "cons") ? ' style="display: none"' : '';
          ?>
         ...
         if ($origem == "res" || (isset($_SESSION['sc_session'][$page][$SC_apl_proc]['scroll_navigate_app']) && $_SESSION['sc_session'][$page][$SC_apl_proc]['scroll_navigate_app']))
          {
              $opc = "RC";
          ?>
