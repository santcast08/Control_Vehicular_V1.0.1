<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idvehiculo" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idvehiculo']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_vehiculo_correctivo"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['where_detal']))
  {
?>  
...
{
    window.open('<?php echo $this->Ini->path_link . "" . SC_dir_app_name('form_vehiculo_correctivo') . "/form_vehiculo_correctivo_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . $this->form_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id();?>"&apl_prt=form_vehiculo_correctivo.php&opcao=print&cor_print=CO','','location=no,menubar,resizable,scrollbars,status=no,toolbar');
}
