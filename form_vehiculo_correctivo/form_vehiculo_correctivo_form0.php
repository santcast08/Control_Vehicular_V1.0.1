...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Ingreso de datos del mantenimiento correctivo"); } else { echo strip_tags("Ingreso de datos del mantenimiento correctivo"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['embutida_pdf']))
 {
 ?>
<?php
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_vehiculo_correctivo/form_vehiculo_correctivo_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_vehiculo_correctivo_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_vehiculo_correctivo_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['recarga'];
}
?>
...
<?php
 include_once("form_vehiculo_correctivo_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_vehiculo_correctivo'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_vehiculo_correctivo'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "Ingreso de datos del mantenimiento correctivo"; } else { echo "Ingreso de datos del mantenimiento correctivo"; } ?></span></td>
...
?>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_chasis_line" id="hidden_field_data_vehiculo_chasis" style="<?php echo $sStyleHidden_vehiculo_chasis; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_chasis_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_chasis_label"><span id="id_label_vehiculo_chasis"><?php echo $this->nm_new_label['vehiculo_chasis']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['php_cmp_required']['vehiculo_chasis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['php_cmp_required']['vehiculo_chasis'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_km_galon_line" id="hidden_field_data_vehiculo_km_galon" style="<?php echo $sStyleHidden_vehiculo_km_galon; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_km_galon_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_km_galon_label"><span id="id_label_vehiculo_km_galon"><?php echo $this->nm_new_label['vehiculo_km_galon']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['php_cmp_required']['vehiculo_km_galon']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['php_cmp_required']['vehiculo_km_galon'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vehiculo_tipo_combustible_line" id="hidden_field_data_vehiculo_tipo_combustible" style="<?php echo $sStyleHidden_vehiculo_tipo_combustible; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vehiculo_tipo_combustible_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vehiculo_tipo_combustible_label"><span id="id_label_vehiculo_tipo_combustible"><?php echo $this->nm_new_label['vehiculo_tipo_combustible']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['php_cmp_required']['vehiculo_tipo_combustible']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['php_cmp_required']['vehiculo_tipo_combustible'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<TABLE align="center" id="hidden_bloco_1" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['correctivos']))
    {
        $this->nm_new_label['correctivos'] = "correctivos";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $correctivos = $this->correctivos;
   $sStyleHidden_correctivos = '';
   if (isset($this->nmgp_cmp_hidden['correctivos']) && $this->nmgp_cmp_hidden['correctivos'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['correctivos']);
       $sStyleHidden_correctivos = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_correctivos = 'display: none;';
   $sStyleReadInp_correctivos = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['correctivos']) && $this->nmgp_cmp_readonly['correctivos'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['correctivos']);
       $sStyleReadLab_correctivos = '';
       $sStyleReadInp_correctivos = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['correctivos']) && $this->nmgp_cmp_hidden['correctivos'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="correctivos" value="<?php echo $this->form_encode_input($correctivos) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_correctivos_line" id="hidden_field_data_correctivos" style="<?php echo $sStyleHidden_correctivos; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_correctivos_line" style="vertical-align: top;padding: 0px">
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_correctivos'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_correctivos'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_correctivos'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] ]['form_correctivo']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] ]['form_correctivo']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] ]['form_correctivo']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] ]['form_correctivo']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] ]['form_correctivo']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] ]['form_correctivo']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] ]['form_correctivo']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] ]['form_correctivo']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] ]['form_correctivo']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] ]['form_correctivo']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] ]['form_correctivo']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] ]['form_correctivo']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init'] ]['form_vehiculo_correctivo']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_vehiculo_correctivo_empty.htm' : $this->Ini->link_form_correctivo_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=500';
if (isset($this->Ini->sc_lig_target['C_@scinf_correctivos']) && 'nmsc_iframe_liga_form_correctivo' != $this->Ini->sc_lig_target['C_@scinf_correctivos'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_correctivos'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['form_correctivo_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
    scOpenMasterDetail("<?php echo $this->Ini->sc_lig_target['C_@scinf_correctivos'] ?>", "<?php echo $sDetailSrc; ?>");
});
</script>
<?php
}
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_correctivo"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="500" width="100%" name="nmsc_iframe_liga_form_correctivo"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_correctivos_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_correctivos_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculo_correctivo']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_vehiculo_correctivo");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_vehiculo_correctivo");
 parent.scAjaxDetailHeight("form_vehiculo_correctivo", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
