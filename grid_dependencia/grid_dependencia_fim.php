...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Control_Vehicular_____grid_dependencia"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Control_Vehicular_____grid_dependencia"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_dependencia'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dependencia']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_dependencia']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dependencia']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_dependencia']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_dependencia']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_dependencia']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_dependencia']['embutida_filho'] as $ind => $sc_init)
          {
