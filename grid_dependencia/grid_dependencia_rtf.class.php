...
class grid_dependencia_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_dependencia.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['rtf_name']);
      }
   ...
   function NM_export_dependencia_descripcion()
   {
         ...
         $this->dependencia_descripcion = str_replace('<', '&lt;', $this->dependencia_descripcion);
         $this->dependencia_descripcion = str_replace('>', '&gt;', $this->dependencia_descripcion);
         $this->Texto_tag .= "<td>" . $this->dependencia_descripcion . "</td>\r\n";
   }
   //----- dependencia_estado
   function NM_export_dependencia_estado()
   {
         ...
         $this->dependencia_estado = str_replace('<', '&lt;', $this->dependencia_estado);
         $this->dependencia_estado = str_replace('>', '&gt;', $this->dependencia_estado);
         $this->Texto_tag .= "<td>" . $this->dependencia_estado . "</td>\r\n";
   }
   //----- iddependencia
   function NM_export_iddependencia()
   {
         ...
         $this->iddependencia = str_replace('<', '&lt;', $this->iddependencia);
         $this->iddependencia = str_replace('>', '&gt;', $this->iddependencia);
         $this->Texto_tag .= "<td>" . $this->iddependencia . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
