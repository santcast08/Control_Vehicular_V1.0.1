...
class grid_dependencia_xls
{
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_dependencia" . $this->Xls_tp;
          $this->Tit_doc    = "grid_dependencia" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['embutida_label'])
      { 
      ...
      while (!$rs->EOF)
      {
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['embutida'])
         { 
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['embutida'])
      { 
   ...
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         $this->dependencia_descripcion = html_entity_decode($this->dependencia_descripcion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->dependencia_descripcion = strip_tags($this->dependencia_descripcion);
         if (!NM_is_utf8($this->dependencia_descripcion))
         {
             $this->dependencia_descripcion = sc_convert_encoding($this->dependencia_descripcion, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->dependencia_descripcion, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- dependencia_estado
   ...
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         $this->dependencia_estado = html_entity_decode($this->dependencia_estado, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->dependencia_estado = strip_tags($this->dependencia_estado);
         if (!NM_is_utf8($this->dependencia_estado))
         {
             $this->dependencia_estado = sc_convert_encoding($this->dependencia_estado, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->dependencia_estado, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- iddependencia
   ...
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!NM_is_utf8($this->iddependencia))
         {
             $this->iddependencia = sc_convert_encoding($this->iddependencia, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->iddependencia))
         {
             $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getNumberFormat()->setFormatCode('###0');
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->iddependencia);
         $this->Xls_col++;
   }
   //----- dependencia_descripcion
   function NM_sub_cons_dependencia_descripcion()
   {
         $this->dependencia_descripcion = html_entity_decode($this->dependencia_descripcion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->dependencia_descripcion = strip_tags($this->dependencia_descripcion);
         if (!NM_is_utf8($this->dependencia_descripcion))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->dependencia_descripcion;
   ...
   //----- dependencia_estado
   function NM_sub_cons_dependencia_estado()
   {
         $this->dependencia_estado = html_entity_decode($this->dependencia_estado, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->dependencia_estado = strip_tags($this->dependencia_estado);
         if (!NM_is_utf8($this->dependencia_estado))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->dependencia_estado;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- iddependencia
   function NM_sub_cons_iddependencia()
   {
         if (!NM_is_utf8($this->iddependencia))
         {
             $this->iddependencia = sc_convert_encoding($this->iddependencia, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->iddependencia;
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>Dependencias :: Excel</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dependencia']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
