<?php
class form_detalle_movilizacion_form extends form_detalle_movilizacion_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_detalle_movilizacion/form_detalle_movilizacion_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_detalle_movilizacion_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_detalle_movilizacion_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['recarga'];
}
...
<?php
 include_once("form_detalle_movilizacion_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_detalle_movilizacion'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_detalle_movilizacion'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['detalle_movilizacion_destino_']) && $this->nmgp_cmp_hidden['detalle_movilizacion_destino_'] == 'off') { $sStyleHidden_detalle_movilizacion_destino_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['detalle_movilizacion_destino_'])) {
          $this->nm_new_label['detalle_movilizacion_destino_'] = "Destno"; } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_detalle_movilizacion);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_detalle_movilizacion = $this->form_vert_form_detalle_movilizacion;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_detalle_movilizacion))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_detalle_movilizacion as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->id_movilizacion_ = $this->form_vert_form_detalle_movilizacion[$sc_seq_vert]['id_movilizacion_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->detalle_movilizacion_origen_ = $this->form_vert_form_detalle_movilizacion[$sc_seq_vert]['detalle_movilizacion_origen_']; 
       ...
       if (isset($this->nmgp_cmp_readonly['detalle_movilizacion_origen_']) && $this->nmgp_cmp_readonly['detalle_movilizacion_origen_'] == 'on')
       {
       ...
       $this->detalle_movilizacion_destino_ = $this->form_vert_form_detalle_movilizacion[$sc_seq_vert]['detalle_movilizacion_destino_']; 
       ...
       if (isset($this->nmgp_cmp_readonly['detalle_movilizacion_destino_']) && $this->nmgp_cmp_readonly['detalle_movilizacion_destino_'] == 'on')
       {
       ...
       $this->detalle_movilizacion_fecha_inicio_ = $this->form_vert_form_detalle_movilizacion[$sc_seq_vert]['detalle_movilizacion_fecha_inicio_']; 
       ...
       if (isset($this->nmgp_cmp_readonly['detalle_movilizacion_fecha_inicio_']) && $this->nmgp_cmp_readonly['detalle_movilizacion_fecha_inicio_'] == 'on')
       {
       ...
       $this->detalle_movilizacion_fecha_fin_ = $this->form_vert_form_detalle_movilizacion[$sc_seq_vert]['detalle_movilizacion_fecha_fin_']; 
       ...
       if (isset($this->nmgp_cmp_readonly['detalle_movilizacion_fecha_fin_']) && $this->nmgp_cmp_readonly['detalle_movilizacion_fecha_fin_'] == 'on')
       {
       ...
       $this->detalle_movilizacion_distancia_ = $this->form_vert_form_detalle_movilizacion[$sc_seq_vert]['detalle_movilizacion_distancia_']; 
       ...
       if (isset($this->nmgp_cmp_readonly['detalle_movilizacion_distancia_']) && $this->nmgp_cmp_readonly['detalle_movilizacion_distancia_'] == 'on')
       {
       ...
       $this->iddetalle_movilizacion_ = $this->form_vert_form_detalle_movilizacion[$sc_seq_vert]['iddetalle_movilizacion_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_detalle_movilizacion_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_detalle_movilizacion_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_detalle_movilizacion_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_detalle_movilizacion_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_detalle_movilizacion_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_detalle_movilizacion_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php if ($bTestReadOnly_detalle_movilizacion_origen_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["detalle_movilizacion_origen_"]) &&  $this->nmgp_cmp_readonly["detalle_movilizacion_origen_"] == "on") { 
...
?>
<input type="hidden" name="detalle_movilizacion_origen_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($detalle_movilizacion_origen_) . "\">" . $detalle_movilizacion_origen__look . ""; ?>
<?php } else { ?>
<?php
...
<?php if ($bTestReadOnly_detalle_movilizacion_destino_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["detalle_movilizacion_destino_"]) &&  $this->nmgp_cmp_readonly["detalle_movilizacion_destino_"] == "on") { 
...
?>
<input type="hidden" name="detalle_movilizacion_destino_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($detalle_movilizacion_destino_) . "\">" . $detalle_movilizacion_destino__look . ""; ?>
<?php } else { ?>
<?php
...
<?php if ($bTestReadOnly_detalle_movilizacion_fecha_inicio_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["detalle_movilizacion_fecha_inicio_"]) &&  $this->nmgp_cmp_readonly["detalle_movilizacion_fecha_inicio_"] == "on") { 

 ?>
<input type="hidden" name="detalle_movilizacion_fecha_inicio_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($detalle_movilizacion_fecha_inicio_) . "\">" . $detalle_movilizacion_fecha_inicio_ . ""; ?>
<?php } else { ?>
...
<?php if ($bTestReadOnly_detalle_movilizacion_fecha_fin_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["detalle_movilizacion_fecha_fin_"]) &&  $this->nmgp_cmp_readonly["detalle_movilizacion_fecha_fin_"] == "on") { 

 ?>
<input type="hidden" name="detalle_movilizacion_fecha_fin_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($detalle_movilizacion_fecha_fin_) . "\">" . $detalle_movilizacion_fecha_fin_ . ""; ?>
<?php } else { ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_detalle_movilizacion = $guarda_form_vert_form_detalle_movilizacion;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_detalle_movilizacion");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_detalle_movilizacion");
 parent.scAjaxDetailHeight("form_detalle_movilizacion", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_detalle_movilizacion_add_new_line(); return false;
			 return;
		}
