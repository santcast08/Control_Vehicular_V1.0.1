...
class grid_movilizacion_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_movilizacion.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion']['rtf_name']);
      }
   ...
   function NM_export_idvehiculo()
   {
         ...
         $this->look_idvehiculo = str_replace('<', '&lt;', $this->look_idvehiculo);
         $this->look_idvehiculo = str_replace('>', '&gt;', $this->look_idvehiculo);
         $this->Texto_tag .= "<td>" . $this->look_idvehiculo . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
