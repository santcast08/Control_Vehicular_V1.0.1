...
<?php
   ...
   $Ord_Cmp = new grid_movilizacion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_movilizacion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['idusuario'] = "on";
   $tab_def_campos['idusuario'] = "idusuario";
   $tab_converte["idusuario"]   = "idusuario";
   $tab_labels["idusuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion']['labels']["idusuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_movilizacion']['labels']["idusuario"] : "Conductor";
   $tab_ger_campos['idvehiculo'] = "on";
   $tab_def_campos['idvehiculo'] = "IdVehiculo";
   $tab_converte["IdVehiculo"]   = "idvehiculo";
   $tab_labels["idvehiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion']['labels']["idvehiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_movilizacion']['labels']["idvehiculo"] : "Vehiculo";
   $tab_ger_campos['movilizacion_funcionario'] = "on";
   $tab_def_campos['movilizacion_funcionario'] = "movilizacion_funcionario";
   $tab_converte["movilizacion_funcionario"]   = "movilizacion_funcionario";
   $tab_labels["movilizacion_funcionario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion']['labels']["movilizacion_funcionario"])) ? $_SESSION['sc_session'][$sc_init]['grid_movilizacion']['labels']["movilizacion_funcionario"] : "Movilizacion Funcionario";
   $tab_ger_campos['movilizacion_fecha'] = "on";
   $tab_def_campos['movilizacion_fecha'] = "Movilizacion_Fecha";
   $tab_converte["Movilizacion_Fecha"]   = "movilizacion_fecha";
   $tab_labels["movilizacion_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion']['labels']["movilizacion_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_movilizacion']['labels']["movilizacion_fecha"] : "Movilizacion Fecha";
   $tab_ger_campos['movilizacion_hora_salida'] = "on";
   $tab_def_campos['movilizacion_hora_salida'] = "Movilizacion_Hora_Salida";
   $tab_converte["Movilizacion_Hora_Salida"]   = "movilizacion_hora_salida";
   $tab_labels["movilizacion_hora_salida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion']['labels']["movilizacion_hora_salida"])) ? $_SESSION['sc_session'][$sc_init]['grid_movilizacion']['labels']["movilizacion_hora_salida"] : "Movilizacion Hora Salida";
   $tab_ger_campos['movilizacion_hora_llegada'] = "on";
   $tab_def_campos['movilizacion_hora_llegada'] = "Movilizacion_Hora_Llegada";
   $tab_converte["Movilizacion_Hora_Llegada"]   = "movilizacion_hora_llegada";
   $tab_labels["movilizacion_hora_llegada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion']['labels']["movilizacion_hora_llegada"])) ? $_SESSION['sc_session'][$sc_init]['grid_movilizacion']['labels']["movilizacion_hora_llegada"] : "Movilizacion Hora Llegada";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_movilizacion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_movilizacion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_movilizacion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_movilizacion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_movilizacion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_movilizacion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_movilizacion']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> movilizacion</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_movilizacion_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_movilizacion']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
